...
class ModelAbsensiEstudante extends Model
{
    protected $table            = 'absensi_estudante';
    protected $primaryKey       = 'id_absensi_estudante';
    protected $useAutoIncrement = true;
    protected $returnType       = 'object';
    protected $useSoftDeletes   = false;
    protected $protectFields    = true;
    protected $allowedFields    = ['absensi_estudantes', 'data_absensi_estudante', 'absensi', 'numero_absensi', 'aktivo_absensi'];
    ...
    public function getabsensiestudante()
    {
        $this->db = \Config\Database::connect();
        $builder = $this->db->table('absensi_estudante');

        $builder->select('absensi_estudante.absensi_estudantes, estudante.id_estudante, 
        estudante.naran_kompletos as naran_kompleto_estudante,administrator.naran_kompleto as naran_kompleto_professores, administrator.image_administrator, professores.titulo_professores,horario_estudante.id_horario_estudante, horario_estudante.kode_materia_estudante, horario_estudante.materia_horario_estudante, horario_estudante.horario_classe_estudante, horario_estudante.level_horario_estudante, horario_estudante.data_horario_estudante, horario_estudante.horas_horario_estudante, horario_estudante.loron_horario_estudante, horario_estudante.total_horario_estudante, materia_professores.id_materia_professores, materia_kursus.level_materia_kursus, materia_kursus.materia_kursus, horario.id_horario, absensi_estudante.data_absensi_estudante, absensi_estudante.absensi,  absensi_estudante.numero_absensi,  sistema.sistema');

        $builder->join('horario_estudante', 'absensi_estudante.absensi_estudantes = horario_estudante.id_horario_estudante', 'left');
    ...
    function absensiestudantePagination($num, $keyword = null)
    {
       $this->select('absensi_estudante.absensi_estudantes, estudante.id_estudante, 
        estudante.naran_kompletos as naran_kompleto_estudante,administrator.naran_kompleto as naran_kompleto_professores, administrator.image_administrator, professores.titulo_professores,horario_estudante.id_horario_estudante, horario_estudante.kode_materia_estudante, horario_estudante.materia_horario_estudante, horario_estudante.horario_classe_estudante, horario_estudante.level_horario_estudante, horario_estudante.data_horario_estudante, horario_estudante.horas_horario_estudante, horario_estudante.loron_horario_estudante, horario_estudante.total_horario_estudante, materia_professores.id_materia_professores, materia_kursus.level_materia_kursus, materia_kursus.materia_kursus, horario.id_horario, absensi_estudante.data_absensi_estudante, absensi_estudante.absensi,absensi_estudante.numero_absensi,  sistema.sistema');

        $this->join('horario_estudante', 'absensi_estudante.absensi_estudantes = horario_estudante.id_horario_estudante', 'left');
        ...
        $this->orderBy('id_absensi_estudante', 'DESC');
        return [
            'absensiestudante' =>$this->paginate($num),
            'pager'   =>$this->pager,
        ];
    }

    public function filterabsensiestudante($num)
    {
        $this->select('absensi_estudante.absensi_estudantes, estudante.id_estudante, 
        estudante.naran_kompletos as naran_kompleto_estudante,administrator.naran_kompleto as naran_kompleto_professores, administrator.image_administrator, professores.titulo_professores,horario_estudante.id_horario_estudante, horario_estudante.kode_materia_estudante, horario_estudante.materia_horario_estudante, horario_estudante.horario_classe_estudante, horario_estudante.level_horario_estudante, horario_estudante.data_horario_estudante, horario_estudante.horas_horario_estudante, horario_estudante.loron_horario_estudante, horario_estudante.total_horario_estudante, materia_professores.id_materia_professores, materia_kursus.level_materia_kursus, materia_kursus.materia_kursus, horario.id_horario, absensi_estudante.data_absensi_estudante, absensi_estudante.absensi, absensi_estudante.numero_absensi,  sistema.sistema');
        ...
        $this->where('data_absensi_estudante >=', $start);
        $this->where('data_absensi_estudante <=', $end);
        return [
            'absensiestudante' =>$this->paginate($num),
            'pager'   =>$this->pager,
        ];
    ...
    public function resultabsensiestudante()
    {
        $this->select('absensi_estudante.absensi_estudantes, estudante.id_estudante, 
        estudante.naran_kompletos as naran_kompleto_estudante,administrator.naran_kompleto as naran_kompleto_professores, administrator.image_administrator, professores.titulo_professores,horario_estudante.id_horario_estudante, horario_estudante.kode_materia_estudante, horario_estudante.materia_horario_estudante, horario_estudante.horario_classe_estudante, horario_estudante.level_horario_estudante, horario_estudante.data_horario_estudante, horario_estudante.horas_horario_estudante, horario_estudante.loron_horario_estudante, horario_estudante.total_horario_estudante, materia_professores.id_materia_professores, materia_kursus.level_materia_kursus, materia_kursus.materia_kursus, horario.id_horario, absensi_estudante.data_absensi_estudante, absensi_estudante.absensi, absensi_estudante.numero_absensi,  sistema.sistema');
    ...
    function absensiPagination($num, $keyword = null)
    {
    ...
    public function filterabsensi($num)
    {
        $estudante = helperEstudante()->id_estudante;
        $this->select('absensi_estudante.absensi_estudantes, estudante.id_estudante, 
        estudante.naran_kompletos as naran_kompleto_estudante,administrator.naran_kompleto as naran_kompleto_professores, administrator.image_administrator, professores.titulo_professores,horario_estudante.id_horario_estudante, horario_estudante.kode_materia_estudante, horario_estudante.materia_horario_estudante, horario_estudante.horario_classe_estudante, horario_estudante.level_horario_estudante, horario_estudante.data_horario_estudante, horario_estudante.horas_horario_estudante, horario_estudante.loron_horario_estudante, horario_estudante.total_horario_estudante, materia_professores.id_materia_professores, materia_kursus.level_materia_kursus, materia_kursus.materia_kursus, horario.id_horario, absensi_estudante.data_absensi_estudante, absensi_estudante.absensi, absensi_estudante.numero_absensi,  sistema.sistema');
    ...
    public function rowabsensiestudante()
    {
        $estudante = helperEstudante()->id_estudante;
        $this->select('absensi_estudante.absensi_estudantes, estudante.id_estudante, 
        estudante.naran_kompletos as naran_kompleto_estudante,administrator.naran_kompleto as naran_kompleto_professores, administrator.image_administrator, professores.titulo_professores,horario_estudante.id_horario_estudante, horario_estudante.kode_materia_estudante, horario_estudante.materia_horario_estudante, horario_estudante.horario_classe_estudante, horario_estudante.level_horario_estudante, horario_estudante.data_horario_estudante, horario_estudante.horas_horario_estudante, horario_estudante.loron_horario_estudante, horario_estudante.total_horario_estudante, materia_professores.id_materia_professores, materia_kursus.level_materia_kursus, materia_kursus.materia_kursus, horario.id_horario, absensi_estudante.data_absensi_estudante, absensi_estudante.absensi, absensi_estudante.numero_absensi,  sistema.sistema');
        ...
        $query = $this->where('id_estudante =', $estudante)->findAll(); 
        return $query;
    }

    public function absensiestudante()
    {
        $estudante = helperEstudante()->id_estudante;
        $this->select('absensi_estudante.absensi_estudantes, estudante.id_estudante, 
        estudante.naran_kompletos as naran_kompleto_estudante,administrator.naran_kompleto as naran_kompleto_professores, administrator.image_administrator, professores.titulo_professores,horario_estudante.id_horario_estudante, horario_estudante.kode_materia_estudante, horario_estudante.materia_horario_estudante, horario_estudante.horario_classe_estudante, horario_estudante.level_horario_estudante, horario_estudante.data_horario_estudante, horario_estudante.horas_horario_estudante, horario_estudante.loron_horario_estudante, horario_estudante.total_horario_estudante, materia_professores.id_materia_professores, materia_kursus.level_materia_kursus, materia_kursus.materia_kursus, horario.id_horario, absensi_estudante.data_absensi_estudante, absensi_estudante.absensi, absensi_estudante.numero_absensi,  sistema.sistema');
    ...
    public function sumabsensiestudante()
    {
        $estudante = helperEstudante()->id_estudante;
        $this->select('absensi_estudante.absensi_estudantes, estudante.id_estudante, 
        estudante.naran_kompletos as naran_kompleto_estudante,administrator.naran_kompleto as naran_kompleto_professores, administrator.image_administrator, professores.titulo_professores,horario_estudante.id_horario_estudante, horario_estudante.kode_materia_estudante, horario_estudante.materia_horario_estudante, horario_estudante.horario_classe_estudante, horario_estudante.level_horario_estudante, horario_estudante.data_horario_estudante, horario_estudante.horas_horario_estudante, horario_estudante.loron_horario_estudante, horario_estudante.total_horario_estudante, materia_professores.id_materia_professores, materia_kursus.level_materia_kursus, materia_kursus.materia_kursus, horario.id_horario, absensi_estudante.data_absensi_estudante, absensi_estudante.absensi, absensi_estudante.numero_absensi,  sistema.sistema');
        ...
        $query = $this->where('id_estudante =', $estudante)->select('sum(numero_absensi) as numeroabsensi')->first(); 
