...
class Horarioportfolio extends ResourceController
{
    ...
    public function index()
    {
        ...
        return view('administrator/horarioprofessores/horarioprofessores', $data);
    }
    ...
    public function show($id = null)
    {
        ...
        return view('administrator/horarioprofessores/detailhorarioprofessores', $data);
    }
 public function detailmateria($lian, $id = null)
    {
      $keyword = $this->request->getGet('keyword');
        ...
        return view('administrator/horarioprofessores/preparasaunmateria', $data);  
    }
    public function aumenta($id = null)
    {
        ...
        return view('administrator/horarioprofessores/aumentahorarioprofessores', $data);
    }
    ...
    public function create()
    {
        ...
        if (!$validate) {
            ...
            if (!$insert) {
                ...
                return redirect()->to(base_url(lang('horarioProfessores.showHorarioPortfolioUrlPortfolio').$horario_professores))->with('success',''.lang('classePortfolio.successValidation').'');
            }
        }
    }
    ...
    public function edithorario($id = null, $horario)
    {
        ...
        return view('administrator/horarioprofessores/trokahorarioprofessores', $data);
    }
