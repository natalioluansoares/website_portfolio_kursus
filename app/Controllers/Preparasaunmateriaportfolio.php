...
class Preparasaunmateriaportfolio extends ResourceController
{
    ...
    public function detailmateria($lian, $id = null)
    {
      $keyword = $this->request->getGet('keyword');
        ...
        return view('administrator/preparasaunmateria/preparasaunmateria', $data);  
    }
    ...
    public function aumenta($id)
    {
        ...
        return view('administrator/preparasaunmateria/aumentapreparasaunmateria', $data);
    }
    ...
    public function create()
    {
        ...
        if (!$validate) {
            ...
            if (!$insert) {
                ...
                return redirect()->to(base_url(lang('preparasaunMateria.preparasaunPreparasaunMateriaPortfolioUrlPortfolio').$level_preparasaun_materia))->with('success',''.lang('classePortfolio.successValidation').'');
            }
        }
    }
    ...
    public function editmateria($lian, $professores, $id = null)
    {
        ...
        return view('administrator/preparasaunmateria/trokapreparasaunmateria', $data);  
    }
