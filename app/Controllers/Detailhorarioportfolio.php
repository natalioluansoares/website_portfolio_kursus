...
class Detailhorarioportfolio extends BaseController
{
    ...
    public function index()
    {
        ...
        return view('administrator/horarioprofessores/detailhotuhorarioprofessores', $data);
    }
    public function pdfhorarioprofessores()
    {
        ...
        $view = view('administrator/printhorarioprofessores/pdfhorarioprofessores', $data);
        ...
        $dompdf->stream((helperSistema()->naran_kompleto), array("Attachment" =>false));
    }
}
