...
class Subsidiofunsionario extends ResourceController
{
    ...
    public function index()
    {
        ...
        // print_r($keyword);
         ...
         if (null !== $this->request->getGet('filter-data')) {
            ...
            if ($data['osansai'] == null) {
                return redirect()->to(base_url(lang('subsidioPortfolio.subsidioUrlFunsionario')))->with('error', ''.lang('osanSaiPortfolio.bukaValidation').'');
            }
         }else{
            $keyword = $this->request->getGet('keyword');
            // print_r($keyword);
        ...
        return view('funsionario/subsidio/osansai', $data);
    }
    ...
    public function show($id = null)
    {
        ...
        if (!$data['osansai']) {
         ...
         if (null !== $this->request->getGet('filter-data')) {
            ...
            if ($data['subsidio'] == null) {
                return redirect()->to(base_url(lang('subsidioPortfolio.showSubsidioUrlFunsionario').$id))->with('error', ''.lang('subsidioPortfolio.bukaValidation').'');
            }
         }else{
            $keyword = $this->request->getGet('keyword');
            // print_r($keyword);
        ...
        return view('funsionario/subsidio/subsidio', $data);
    }

    
    public function newsubsidio($id)
    {
        ...
        return view('funsionario/subsidio/aumentasubsidio',$data);
    }
        ...
        $validate = $this->validate([
            ...
            if ($data['total_subsidio'] > $totalsaldoosansai->total_osan_sai) {
                ...
                if (!$insert) {
                    ...
                    return redirect()->to(base_url(lang('subsidioPortfolio.showSubsidioUrlFunsionario').$salario_subsidio_osan_sai))->with('success',''.lang('funsionarioPortfolio.successValidation').'');
                }
            }
        }
    }
    ...
    public function edit($id = null)
    {
        ...
        return view('funsionario/subsidio/trokasubsidio',$data);
    }
    ...
    public function exportPdf($id = null)
    {
        ...
        $administrator = $this->administrator->orderBy('id_administrator', 'DESC')->where('aktivo_administrator =', null)->where('valido_administrator =', 1)->where('sistema_administrator =', 5)
         ->resultadministrator();
        if (null !== $this->request->getGet('filter-data')) {
        ...
        $view = view('funsionario/subsidio/pdfsubsidio', $data);
