...
<?= $this->section('administrator') ?>
    <title><?=lang('sidebarPortfolio.temporarioOsanSaiPortfolio')?></title>
<?= $this->endSection() ?>
<?= $this->section('administrator') ?>
<!-- start page title -->
<div class="mb-3"></div>
<div class="row">
    <div class="col-lg-12">
        <div class="mb-3">
            ...
            <h4 class="page-title"><?=lang('sidebarPortfolio.temporarioOsanSaiPortfolio')?></h4>
            </div>
        </div>
    </div>
</div>
                        ...
                        <div class="input-group">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    <a href="#" class="dropdown-item ms-1 btn-animation" data-animation="jello" data-toggle="modal" data-target=".hamoshotuosansaipermanente" ><?= lang('osanSaiPortfolio.deleteOsanSaiPortfolio') ?></a>
                                    <a href="#" class="dropdown-item ms-1 btn-animation" data-animation="slideInUp" data-toggle="modal" data-target=".hamoshotuosansaitemporario" ><?= lang('osanSaiPortfolio.restoryOsanSaiPortfolio') ?></a>
                                </div>
                            </div>
                        </div>
                    </form>
                        ...
                        <center>
                            <table>
                                <thead>
                                    <tr>
                                        <th>
                                            <a href="" class="btn btn-danger btn-animation" data-animation="rubberBand" data-toggle="modal" data-target=".osansaipermanente" id="permanenteosansai" 
                                            data-id="<?= $portfolio->id_osan_sai; ?>">
                                            <i class="uil-trash"></i>
                                            </a>
                                        </th>
                                        <th>
                                            <a href="" class="btn btn-warning btn-animation ms-1" data-animation="slideInDown" data-toggle="modal" data-target=".hamososansaitemporario" id="temporariohamososansai" 
                                                data-id="<?= $portfolio->id_osan_sai; ?>">
...
<!-- Hamos Permanente -->
<div class="modal fade osansaipermanente" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <center>
                <h3><?=lang('hamosPortfolio.perguntasHamos') ?></h3>
            </center>
            <form action="<?=base_url(lang('osanSaiPortfolio.permanenteTemporarioOsanSaiUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
...
<div class="modal fade hamoshotuosansaipermanente" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <center>
                <h3><?=lang('hamosPortfolio.perguntasHamos') ?></h3>
            </center>
            <form action="<?=base_url(lang('osanSaiPortfolio.hotuPermanenteTemporarioOsanSaiUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <center>
                        <font size="15" style="color: red;"><i class="mdi mdi-map-marker-question-outline"></i></font>
...
<!-- Hamos Temporario -->
<div class="modal fade hamososansaitemporario" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <center>
                <h3><?=lang('hamosPortfolio.perguntasHamos') ?></h3>
            </center>
            <form action="<?=base_url(lang('osanSaiPortfolio.hamosTemporarioOsanSaiUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <center>
                        <font size="15" style="color: red;"><i class="mdi mdi-map-marker-question-outline"></i></font>
...
<div class="modal fade hamoshotuosansaitemporario" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <center>
                <h3><?=lang('hamosPortfolio.perguntasHamos') ?></h3>
            </center>
            <form action="<?=base_url(lang('osanSaiPortfolio.hamosHotuTemporarioOsanSaiUrlPortfolio')) ?>" method="get">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <center>
                        <font size="15" style="color: red;"><i class="mdi mdi-map-marker-question-outline"></i></font>
...
<script>
    $(document).on("click", "#permanenteosansai", function() {
    var Id = $(this).data('id');

    $(".osansaipermanente #idsaldo").val(Id);
})
</script>
<script>
    $(document).on("click", "#temporariohamososansai", function() {
    var Id = $(this).data('id');

    $(".hamososansaitemporario #idhamos").val(Id);
})
</script>
<?= $this->endSection() ?>