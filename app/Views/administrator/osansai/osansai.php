...
<?= $this->section('administrator') ?>
    <title><?=lang('sidebarPortfolio.osanSaiPortfolio')?></title>
<?= $this->endSection() ?>
<?= $this->section('administrator') ?>
<!-- start page title -->
<div class="mb-3"></div>
<div class="row">
    <div class="col-lg-3">
        <div class="mb-3">
            ...
            <h4 class="page-title"><?=lang('sidebarPortfolio.osanSaiPortfolio')?></h4>
            </div>
        </div>
    </div>
</div>
                                ...
                                <thead>
                                    <tr>
                                        <?php if ($portfolio->id_osan_sai != 1) { ?>
                                            <th>
                                            <a href="" class="btn btn-danger btn-animation" data-animation="rubberBand" data-toggle="modal" data-target=".trokaosansai" id="osansai" 
                                        ...
                                        <?php } ?>
                                        <th>
                                            <a href="<?=base_url(lang('osanSaiPortfolio.trokaOsanSaiUrlPortfolio').$portfolio->id_osan_sai) ?>" class="btn btn-success"><i class="uil-edit-alt"></i></a>
                                        </th>
                                        <th>
                                            <a href="<?=base_url(lang('osanSaiPortfolio.osanSaiImageUrlPortfolio').$portfolio->id_osan_sai) ?>" class="btn btn-info"><i class="mdi mdi-image-multiple"></i></a>
                                        </th>
                                        <th>
                                            <a href="<?=base_url(lang('osanSaiPortfolio.saldoOsanSaiUrlPortfolio').$portfolio->id_osan_sai) ?>" class="btn btn-warning text-white"><i class="mdi mdi-folder-open"></i></a>
                                        </th>
                                    </tr>
                                </thead>
                            </table>
