...
<div class="row">
    <div class="col-lg-3">
        <div class="mb-3">
            ...
            <h4 class="page-title"><?=lang('sidebarPortfolio.registoPortfolio')?></h4>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="mb-3">
            <div class="page-title-right">
                <div class="app-search dropdown">
                    <form action="<?=base_url(lang('registoAdministrator.registoUrlConta')) ?>" method="get" >
                        <div class="input-group">
                            ...
                            <a href="<?=base_url(lang('registoAdministrator.hamosRegistoUrlConta')) ?>" class="btn btn-danger ms-2">
                ...
                <div class="table-responsive">
                    <table id="selection-datatable" class="table dt-responsive table-bordered nowrap w-100">
                        ...
                        <tbody>
                            ...
                            $no = 1 +(6 * ($page - 1));
                            foreach($administrator as $portfolio): ?>
                            <?php if ($portfolio->sistema == 'Administrator' && $portfolio->aktivo_administrator == null) { ?>
                                <tr>
                                    <td><?=$no++?></td>
                                   ...
                                   <?php } ?>                               
                                    ...
                                    <td>
                                        <a href="" class="btn btn-danger btn-animation" data-animation="jello" data-toggle="modal" data-target=".trokaadministrator" id="administrator" 
                                    data-id="<?= $portfolio->id_administrator; ?>">
                                    <i class="uil-trash"></i>
                                    </a>
                                    </td>
                                    <td><a href="<?=base_url(lang('registoAdministrator.trokaRegistoUrlConta').$portfolio->id_administrator) ?>" class="btn btn-success"><i class="uil-edit-alt"></i></a></td>
                                </tr>
                           <?php } ?>
                            <?php endforeach; ?>
                        </tbody>
