...
<div class="row">
    <div class="col-lg-3">
        <div class="mb-3">
            ...
            <h4 class="page-title"><?=lang('funsionarioPortfolio.registoFunsionarioPortfolio')?></h4>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="app-search dropdown">
                    <form method="get" >
                        <div class="input-group">
                            ...
                            <a href="<?=base_url(lang('funsionarioPortfolio.hamosFunsionarioUrlPortfolio')) ?>" class="btn btn-danger ms-2">
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-footer text-center border-0 mt-0">								
                            <a href="" class="btn btn-danger btn-animation btn-rounded px-2" data-animation="swing" data-toggle="modal" data-target=".trokafunsionario" id="funsionario" 
...
<div class="modal fade trokafunsionario" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?=base_url(lang('funsionarioPortfolio.deleteFunsionarioUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
