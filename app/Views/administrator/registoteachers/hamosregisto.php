...
<?= $this->section('administrator') ?>
    <title><?=lang('registoTeachers.hamosFuncionarioRegistoPortfolio')?></title>
<?= $this->endSection() ?>
<?= $this->section('administrator') ?>
<!-- start page title -->
<div class="mb-3"></div>
<div class="row">
    <div class="col-lg-3">
        <div class="mb-3">
            ...
            <h4 class="page-title"><?=lang('registoTeachers.hamosFuncionarioRegistoPortfolio')?></h4>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="app-search dropdown">
                    <form method="get" >
                        <div class="input-group">
                            ...
                            <a href="<?= base_url(lang('registoTeachers.registoUrlConta'))?>" class="btn btn-dark ms-1">
                                <i class="mdi mdi-skip-previous"></i>
                            </a>
                           <a href="" class="btn btn-danger ms-1 btn-animation" data-animation="slideInUp" data-toggle="modal" data-target=".hamoshotuteacher">
                        ...
                        <tbody>
                            ...
                            <tr>
                               ...
                               <?php } ?>                               
                                ...
                                <td><a href="" class="btn btn-danger btn-animation" data-animation="zoomInLeft" data-toggle="modal" data-target=".permanenteteacher" id="teacher" 
                                data-id="<?= $portfolio->id_administrator; ?>">
                                <i class="uil-trash"></i>
                                </a></td>
                                <td><a href="" class="btn btn-warning btn-animation" data-animation="zoomInRight" data-toggle="modal" data-target=".hamosteacher" id="teachertemporario" 
                                data-id="<?= $portfolio->id_administrator; ?>">
...
<!-- Hamos Permanente -->
<div class="modal fade permanenteteacher" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <center>
                <h3><?=lang('hamosPortfolio.perguntasHamos') ?></h3>
            </center>
            <form action="<?=base_url(lang('registoTeachers.permanenteTeachersUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
...
<!-- Hamos Temporario -->
<div class="modal fade hamosteacher" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <center>
                <h3><?=lang('hamosPortfolio.perguntasHamos') ?></h3>
            </center>
            <form action="<?=base_url(lang('registoTeachers.temporarioTeachersUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <center>
                        <font size="15" style="color: red;"><i class="mdi mdi-map-marker-question-outline"></i></font>
...
<div class="modal fade hamoshotuteacher" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <center>
                <h3><?=lang('hamosPortfolio.perguntasHamos') ?></h3>
            </center>
            <form action="<?=base_url(lang('registoTeachers.hamoshotutemporarioTeachersUrlPortfolio')) ?>" method="get">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <center>
                        <font size="15" style="color: red;"><i class="mdi mdi-map-marker-question-outline"></i></font>
...
<script>
    ...
    $(".permanenteteacher #idteacher").val(Id);
})
</script>
<script>
    $(document).on("click", "#teachertemporario", function() {
    var Id = $(this).data('id');

    $(".hamosteacher #idhamos").val(Id);
})
</script>
<?= $this->endSection() ?>