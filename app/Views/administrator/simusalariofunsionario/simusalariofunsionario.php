...
<?= $this->section('administrator') ?>
    <title><?=lang('sidebarPortfolio.simuSalarioFunionario')?></title>
<?= $this->endSection() ?>
<?= $this->section('administrator') ?>
<!-- start page title -->
<div class="mb-3"></div>
<div class="row">
    <div class="col-lg-3">
        <div class="mb-3">
            ...
            <h4 class="page-title"><?=lang('sidebarPortfolio.simuSalarioFunionario')?></h4>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="app-search dropdown">
                    <form>
                        <div class="input-group">
                            ...
                            <a href="<?=base_url(lang('salarioFunsionario.hamosSimuSalarioFunsionarioProfessoresUrlPortfolio').$salario->id_salario_funsionario)?>" class="btn btn-danger ms-1">
                                <i class="mdi mdi-bucket"></i>
                            </a>
                            <a href="<?=base_url(lang('salarioFunsionario.aumentaSimuSalarioFunsionarioProfessoresUrlPortfolio').$salario->id_salario_funsionario)?>" class="btn btn-info ms-1" style="color:aliceblue">
                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <?php } ?>
                                ...
                                <td align="center"><a href="<?=base_url(lang('salarioFunsionario.editSimuSalarioFunsionarioProfessoresUrlPortfolio').$portfolio->id_salario_simu_funsionario.'/'.$portfolio->salario_simu_funsionario) ?>" class="btn btn-success"><i class="uil-edit-alt"></i></a>
                                </td>
                            </tr>
                            <?php
...
<div class="modal fade trokasimusalario" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?=base_url(lang('salarioFunsionario.trokaSimuSalarioFunsionarioProfessoresUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
