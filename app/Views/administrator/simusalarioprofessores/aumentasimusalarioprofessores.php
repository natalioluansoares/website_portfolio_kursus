            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane show active" id="form-row-preview">
                        <form action="<?=base_url(lang('salarioProfessores.createSimuSalarioFunsionarioProfessoresUrlPortfolio')) ?>" method="post">
                            <?= csrf_field(); ?>
                            <div class="row g-2">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="date" name="data_salario_simu_professores"  class="form-control <?=isset($errors['data_salario_simu_professores']) ? 'is-invalid' : null ?>"  value="<?=old('data_salario_simu_professores')?>"  placeholder="<?=lang('salarioFunsionario.dataFunsionario')?>">
                                    <small class="text-danger">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="time" name="horas_salario_simu_professores" class="form-control <?=isset($errors['horas_salario_simu_professores']) ? 'is-invalid' : null ?>" value="<?=old('horas_salario_simu_professores')?>"  placeholder="<?=lang('salarioFunsionario.horasFunsionario')?>">
                                    <small class="text-danger">
