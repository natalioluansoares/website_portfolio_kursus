...
<div class="row">
    <div class="col-lg-3">
        <div class="mb-3">
            ...
            <h4 class="page-title"><?=lang('sidebarPortfolio.aumentaMateriaProfessoresPortfolio')?></h4>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane show active" id="form-row-preview">
                        <form action="<?=base_url(lang('materiaProfessores.inputMateriaProfessoresPortfolioUrlPortfolio')) ?>" method="post">
                        <?= csrf_field(); ?>
                        <div class="row g-2">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="date" name="data_materia_professores" value="<?=old('data_materia_professores') ?>" class="form-control">
                                <small class="text-danger">
