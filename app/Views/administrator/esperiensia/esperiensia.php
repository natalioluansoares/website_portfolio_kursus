...
<?= $this->section('administrator') ?>
    <title><?=lang('sidebarPortfolio.esperiensiaPortfolio')?></title>
<?= $this->endSection() ?>
<?= $this->section('administrator') ?>
<!-- start page title -->
<div class="mb-3"></div>
<div class="row">
    <div class="col-lg-3">
        <div class="mb-3">
            ...
            <h4 class="page-title"><?=lang('sidebarPortfolio.esperiensiaPortfolio')?></h4>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="app-search dropdown">
                    <form>
                        <div class="input-group">
                            ...
                            <a href="<?=base_url(lang('esperiensiaPortfolio.hamosEsperiensiaUrlPortfolio'))?>" class="btn btn-danger ms-2">
            ...
            <div class="col">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text"><a href="<?=base_url(lang('esperiensiaPortfolio.detailEsperiensiaUrlPortfolio').$portfolio->id_esperiensia) ?>" title="<?=lang('esperiensiaPortfolio.detaiEsperiensialPortfolio') ?>" class="text-dark"><?= substr($portfolio->esperiensia, 0, 300) ?></a></p>
                        <p class="card-text">
                        ...
                        <center>
                            <table>
                                <thead>
                                    <tr>
                                        <th>
                                            <a href="" class="btn btn-danger btn-animation" data-animation="rubberBand" data-toggle="modal" data-target=".trokaesperiensia" id="esperiensia" 
                                            data-id="<?= $portfolio->id_esperiensia; ?>">
                                            <i class="uil-trash"></i>
                                            </a>
                                        </th>
                                        <th>
                                            <a href="<?=base_url(lang('esperiensiaPortfolio.trokaEsperiensiaUrlPortfolio').$portfolio->id_esperiensia) ?>" class="btn btn-success"><i class="uil-edit-alt"></i></a>
                                        </th>
                                        <th>
                                            <a href="<?=base_url(lang('esperiensiaPortfolio.trokaEsperiensiaImageUrlPortfolio').$portfolio->id_esperiensia) ?>" class="btn btn-info"><i class="mdi mdi-image-multiple"></i></a>
                                        </th>
                                    </tr>
                                </thead>
                            </table>
...
<div class="modal fade trokaesperiensia" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <center>
                <h3><?=lang('hamosPortfolio.perguntasHamos') ?></h3>
            </center>
            <form action="<?=base_url(lang('esperiensiaPortfolio.deleteEsperiensiaUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <center>
                        ...
                        <input type="hidden" name="aktivo_esperiensia" value="1" placeholder="Kategori"class="form-control">
                    </center>
                    <center>
...
<script>
    ...
    $(".trokaesperiensia #idesperiensia").val(Id);
})
</script>
<?= $this->endSection() ?>