            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane show active" id="form-row-preview">
                        <form action="<?=base_url(lang('categoriobackendfrontendPortfolio.inputCategorioBackendFrontendUrlPortfolio')) ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="row g-2">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="kode_categorio_backend_frontend" value="<?= old('kode_categorio_backend_frontend') ?>" class="form-control <?=isset($errors['kode_categorio_backend_frontend']) ? 'is-invalid' : null ?>" id="inputEmail4" placeholder="<?=lang('categoriobackendfrontendPortfolio.kodeCategorio')?>">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="categorio_backend_frontend" value="<?= old('categorio_backend_frontend') ?>" class="form-control <?=isset($errors['categorio_backend_frontend']) ? 'is-invalid' : null ?>" id="inputPassword4" placeholder="<?=lang('categoriobackendfrontendPortfolio.categorioCategorio')?>">
                                    <div class="invalid-feedback">
                            ...
                            <div class="row g-2">
                                ...
                                <div class="mb-3 col-md-6">
                                    <label for="inputPassword4" class="form-label"><?=lang('categoriobackendfrontendPortfolio.imageCategorio')?></label>
                                    <input type="file" name="image_categorio_projeito" value="<?= old('image_categorio_projeito') ?>" class="form-control <?=isset($errors['image_categorio_projeito']) ? 'is-invalid' : null ?>" id="inputPassword4" placeholder="<?=lang('categoriobackendfrontendPortfolio.imageCategorio')?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="date" name="data_categorio_backend_frontend" value="<?= old('data_categorio_backend_frontend') ?>" class="form-control <?=isset($errors['data_categorio_backend_frontend']) ? 'is-invalid' : null ?>" id="inputPassword4" placeholder="<?=lang('categoriobackendfrontendPortfolio.dataCategorio')?>">
                                    <div class="invalid-feedback">
                            ...
                            <div class="row g-2">
                                <div class="mb-3 col-md-12">
                                    ...
                                    <textarea name="descripsaun_categorio" id="descripsaun_categorio" cols="30" class="form-control <?=isset($errors['descripsaun_categorio']) ? 'is-invalid' : null ?>" rows="10"><?=old('descripsaun_categorio') ?></textarea>
                                    <div class="invalid-feedback">
