                ...
                <div class="app-search dropdown">
                    <form>
                        <div class="input-group">
                            ...
                            <a href="<?= base_url(lang('classePortfolio.classeUrlPortfolio'))?>" class="btn btn-dark ms-1">
                                <i class="mdi mdi-skip-previous"></i>
                            </a>
                            <a href="" class="btn btn-danger ms-1 btn-animation" data-animation="wobble" data-toggle="modal" data-target=".hamoshotuclasse">
                    ...
                    <table id="selection-datatable" class="table dt-responsive table-bordered nowrap w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="" class="btn btn-danger btn-animation" data-animation="slideInRight" data-toggle="modal" data-target=".permanenteclasse" id="classe" 
                                data-id="<?= $portfolio->id_classe; ?>">
                                <i class="uil-trash"></i>
                                </a></td>
                                <td><a href="" class="btn btn-warning btn-animation" data-animation="slideInLeft" data-toggle="modal" data-target=".hamosclasse" id="classetemporario" 
                                data-id="<?= $portfolio->id_classe; ?>">
...
<!-- Hamos Permanente -->
<div class="modal fade permanenteclasse" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <center>
                <h3><?=lang('hamosPortfolio.perguntasHamos') ?></h3>
            </center>
            <form action="<?=base_url(lang('classePortfolio.permanenteClasseUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
...
<!-- Hamos Temporario -->
<div class="modal fade hamosclasse" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <center>
                <h3><?=lang('hamosPortfolio.perguntasHamos') ?></h3>
            </center>
            <form action="<?=base_url(lang('classePortfolio.temporarioClasseUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <center>
                        <font size="15" style="color: red;"><i class="mdi mdi-map-marker-question-outline"></i></font>
...
<div class="modal fade hamoshotuclasse" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <center>
                <h3><?=lang('hamosPortfolio.perguntasHamos') ?></h3>
            </center>
            <form action="<?=base_url(lang('classePortfolio.hamoshotutemporarioClasseUrlPortfolio')) ?>" method="get">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <center>
                        <font size="15" style="color: red;"><i class="mdi mdi-map-marker-question-outline"></i></font>
...
<script>
    ...
    $(".permanenteclasse #idclasse").val(Id);
})
</script>
<script>
    $(document).on("click", "#classetemporario", function() {
    var Id = $(this).data('id');

    $(".hamosclasse #idhamos").val(Id);
})
</script>
<?= $this->endSection() ?>