...
<div class="row">
    <div class="col-lg-3">
        <div class="mb-3">
            ...
            <h4 class="page-title"><?=lang('sidebarPortfolio.aulaPortfolio')?></h4>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="app-search dropdown">
                    <form>
                        <div class="input-group">
                            ...
                            <a href="<?=base_url(lang('classePortfolio.hamosClasseUrlPortfolio'))?>" class="btn btn-danger ms-2">
                    ...
                    <table id="selection-datatable" class="table dt-responsive table-bordered nowrap w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?=base_url(lang('classePortfolio.trokaClasseUrlPortfolio').$portfolio->id_classe) ?>" class="btn btn-success"><i class="uil-edit-alt"></i></a></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
