            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane show active" id="form-row-preview">
                        <form action="<?=base_url(lang('imprestaSalarioFunsionario.inputImprestaSalarioFunsionarioPortfolioUrlPortfolio')) ?>" method="post">
                            <?= csrf_field(); ?>
                            <div class="row g-2">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="number" name="total_osan_impresta" min="0" class="form-control" value="<?=old('total_osan_impresta')?>"  placeholder="<?=lang('imprestaSalarioFunsionario.totalFunsionario')?>">
                                    <small class="text-danger">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="date" name="data_osan_impresta"  class="form-control"  value="<?=old('data_osan_impresta')?>"  placeholder="<?=lang('imprestaSalarioFunsionario.dataFunsionario')?>">
                                    <small class="text-danger">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="time" name="horas_osan_impresta" min="0" class="form-control" value="<?=old('horas_osan_impresta')?>"  placeholder="<?=lang('imprestaSalarioFunsionario.horasFunsionario')?>">
                                    <small class="text-danger">
