            ...
            <div class="card-body">
                <div class="tab-content">
                    <div class="tab-pane show active" id="form-row-preview">
                        <form action="<?=base_url(lang('sistemaPortfolio.updateSistemaUrlPortfolio').$sistema->id_sistema) ?>" method="post">
                            <?= csrf_field(); ?>
                            <div class="row g-2">
                                <div class="mb-3 col-md-4">
                                    <label for="inputEmail4" class="form-label"><?=lang('sistemaPortfolio.kodeSistema')?></label>
                                    <input type="text" name="kode_sistema" class="form-control <?=isset($errors['kode_sistema']) ? 'is-invalid' : null ?>" value="<?=old('kode_sistema', $sistema->kode_sistema) ?>" placeholder="<?=lang('sistemaPortfolio.kodeSistema')?>">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="text" name="sistema" class="form-control <?=isset($errors['sistema']) ? 'is-invalid' : null ?>" value="<?=old('sistema', $sistema->sistema) ?>" placeholder="<?=lang('sistemaPortfolio.sistemaSistema')?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="date" name="data_sistema" class="form-control <?=isset($errors['data_categorio']) ? 'is-invalid' : null ?>" value="<?=old('data_sistema', $sistema->data_sistema) ?>" placeholder="<?=lang('sistemaPortfolio.dataSistema')?>">
                                    <div class="invalid-feedback">
