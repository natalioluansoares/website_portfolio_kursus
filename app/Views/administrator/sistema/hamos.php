                ...
                <div class="app-search dropdown">
                    <form>
                        <div class="input-group">
                            ...
                            <a href="<?= base_url(lang('sistemaPortfolio.sistemaUrlPortfolio'))?>" class="btn btn-dark ms-1">
                                <i class="mdi mdi-skip-previous"></i>
                            </a>
                            <a href="" class="btn btn-danger ms-1 btn-animation" data-animation="slideInUp" data-toggle="modal" data-target=".hamoshotusistema">
                ...
                <div class="table-responsive">
                    <table id="selection-datatable" class="table dt-responsive table-bordered nowrap w-100">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?=$no++?></td>
                                <td><?=$portfolio->kode_sistema?></td>
                                <td><?=$portfolio->sistema?></td>
                                <td><?=$portfolio->data_sistema?></td>
                                <td><a href="" class="btn btn-danger btn-animation" data-animation="zoomInLeft" data-toggle="modal" data-target=".permanentesistema" id="sistema" 
                                data-id="<?= $portfolio->id_sistema; ?>">
                                <i class="uil-trash"></i>
                                </a></td>
                                <td><a href="" class="btn btn-warning btn-animation" data-animation="zoomInRight" data-toggle="modal" data-target=".hamossistema" id="sistematemporario" 
                                data-id="<?= $portfolio->id_sistema; ?>">
...
<?php } ?>
<!-- Hamos Permanente -->
<div class="modal fade permanentesistema" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <center>
                <h3><?=lang('hamosPortfolio.perguntasHamos') ?></h3>
            </center>
            <form action="<?=base_url(lang('sistemaPortfolio.permanenteSistemaUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <center>
                        ...
                        <input type="hidden" name="id" id="idsistema" placeholder="Kategori"class="form-control">
                    </center>
                    <center>
...
<!-- Hamos Temporario -->
<div class="modal fade hamossistema" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <center>
                <h3><?=lang('hamosPortfolio.perguntasHamos') ?></h3>
            </center>
            <form action="<?=base_url(lang('sistemaPortfolio.temporarioSistemaUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <center>
                        <font size="15" style="color: red;"><i class="mdi mdi-map-marker-question-outline"></i></font>
...
<div class="modal fade hamoshotusistema" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <center>
                <h3><?=lang('hamosPortfolio.perguntasHamos') ?></h3>
            </center>
            <form action="<?=base_url(lang('sistemaPortfolio.hamoshotutemporarioSistemaUrlPortfolio')) ?>" method="get">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <center>
                        <font size="15" style="color: red;"><i class="mdi mdi-map-marker-question-outline"></i></font>
...
<script>
    $(document).on("click", "#sistema", function() {
    var Id = $(this).data('id');

    $(".permanentesistema #idsistema").val(Id);
})
</script>
<script>
    $(document).on("click", "#sistematemporario", function() {
    var Id = $(this).data('id');

    $(".hamossistema #idhamos").val(Id);
})
</script>
<?= $this->endSection() ?>