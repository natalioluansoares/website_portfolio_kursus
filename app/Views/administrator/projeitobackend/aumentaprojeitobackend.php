            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane show active" id="form-row-preview">
                        <form action="<?=base_url(lang('projeitoBackendPortfolio.inputProjeitoBackendFrontendUrlPortfolio')) ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="row g-2">
                                <div class="mb-3 col-md-4">
                                    ...
                                    <select name="projeito_backend_frontend" id="" class="form-control <?=isset($errors['projeito_backend_frontend']) ? 'is-invalid' : null ?>">
                                        <option value=""><?=lang('projeitoBackendPortfolio.hiliCategorioProjeitoBackendFrontend')?></option>
                                        <?php foreach($categorio as $portfolio):?>

                                        <option value="<?=$portfolio->id_categorio_backend_frontend ?>"<?= old('projeito_backend_frontend') == $portfolio->id_categorio_backend_frontend ? 'selected' : null ?>><?=$portfolio->backend_frontend ?>
                                        </option>
                                        <?php endforeach ?>
                                    </select>
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="date" name="data_backend_frontend" value="<?=old('data_backend_frontend') ?>" class="form-control <?=isset($errors['data_backend_frontend']) ? 'is-invalid' : null ?>" id="inputPassword4" placeholder="<?=lang('projeitoBackendPortfolio.dataProjeitoBackendFrontend')?>">
                                    <div class="invalid-feedback">
                            ...
                            <div class="row g-2">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <textarea name="youtube" id="" cols="30" rows="4" placeholder="<?=lang('projeitoBackendPortfolio.youtubeProjeitoBackendFrontend')?>" class="form-control <?=isset($errors['youtube']) ? 'is-invalid' : null ?>"><?=old('youtube') ?></textarea>
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <textarea name="facebook" id="" cols="30" rows="4" placeholder="<?=lang('projeitoBackendPortfolio.facebookProjeitoBackendFrontend')?>" class="form-control <?=isset($errors['facebook']) ? 'is-invalid' : null ?>"><?=old('facebook') ?></textarea>
                                    <div class="invalid-feedback">
                            ...
                            <div class="row g-2">
                                <div class="mb-3 col-md-6">
                                    ...
                                    <textarea name="instagram" id="" cols="30" placeholder="<?=lang('projeitoBackendPortfolio.instagramProjeitoBackendFrontend')?>" rows="4" class="form-control <?=isset($errors['instagram']) ? 'is-invalid' : null ?>"><?=old('instagram') ?></textarea>
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <textarea name="tiktok" id="" placeholder="<?=lang('projeitoBackendPortfolio.tiktokProjeitoBackendFrontend')?>" cols="30" rows="4" class="form-control <?=isset($errors['tiktok']) ? 'is-invalid' : null ?>"><?=old('tiktok') ?></textarea>
                                    <div class="invalid-feedback">
                            ...
                            <div class="row g-2">
                                <div class="mb-3 col-md-12">
                                    ...
                                    <textarea name="titulo_backend_frontend" id="" cols="30" class="form-control <?=isset($errors['titulo_backend_frontend']) ? 'is-invalid' : null ?>" rows="10"><?=old('titulo_backend_frontend') ?></textarea>
                                    <div class="invalid-feedback">
                            ...
                            <div class="row g-2">
                                <div class="mb-3 col-md-12">
                                    ...
                                    <textarea name="descripsaun_backend_frontend" id="" cols="30" class="form-control <?=isset($errors['descripsaun_backend_frontend']) ? 'is-invalid' : null ?>" rows="10"><?=old('descripsaun_backend_frontend') ?></textarea>
                                    <div class="invalid-feedback">
                            ...
                            <div class="row g-2">
                                <div class="mb-3 col-md-12">
                                    ...
                                    <textarea name="materia_backend_frontend" id="materia" cols="30" class="form-control" placeholder="<?=lang('projeitoBackendPortfolio.messageMateria') ?>" rows="10"><?=old('materia_backend_frontend') ?></textarea>
                                </div>
                            </div>
                            <div class="row g-2">
                                <div class="mb-3 col-md-12">
                            ...
                            <?php foreach($categorio as $portfolio):?>
                            <a href="<?= base_url(lang('projeitoBackendPortfolio.showProjeitoBackendFrontendUrlPortfolio').$portfolio->id_categorio_backend_frontend)?>" class="btn btn-info ms-1"><i class="mdi mdi-skip-previous"></i></a>
                            <?php endforeach ?>
                        </form>                      
                    </div> <!-- end preview-->
                </div> <!-- end preview-->
