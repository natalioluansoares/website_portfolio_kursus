...
<div class="row">
    <div class="col-lg-3">
        <div class="mb-3">
            ...
            <h4 class="page-title"><?=lang('sidebarPortfolio.trokaSalarioProfessoresPortfolio')?></h4>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="card">
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <form action="<?=base_url(lang('salarioProfessores.updateSalarioFunsionarioProfessoresUrlPortfolio').$salario->id_salario_professores) ?>" method="post">
                        <?= csrf_field(); ?>
                        <div class="row g-2">
