...
<div class="row">
    <div class="col-lg-3">
        <div class="mb-3">
            ...
            <h4 class="page-title"><?=lang('professoresPortfolio.trokaProfessoresRegistoPortfolio')?></h4>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane show active" id="form-row-preview">
                        <form action="<?=base_url(lang('professoresPortfolio.updateProfessoresUrlPortfolio').$profe->id_professores) ?>" method="post">
                            <?= csrf_field(); ?>
                            <div class="row g-2">
                                <div class="mb-3 col-md-6">
                                    <label for="inputEmail4" class="form-label"><?=lang('professoresPortfolio.tituloProfessores')?></label>
                                    <input type="text" name="titulo_professores" class="form-control <?=isset($errors['titulo_professores']) ? 'is-invalid' : null ?>" id="inputEmail4" value="<?=old('titulo_professores',$profe->titulo_professores) ?>"
