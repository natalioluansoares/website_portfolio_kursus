...
<?= $this->section('administrator') ?>
    <title><?=lang('sidebarPortfolio.aturanProfessoresPortfolioa') ?></title>
<?= $this->endSection() ?>
<?= $this->section('administrator') ?>
<!-- start page title -->
<div class="mb-3"></div>
<div class="row">
    <div class="col-lg-3">
        <div class="mb-3">
            ...
            <h4 class="page-title"><?=lang('sidebarPortfolio.aturanProfessoresPortfolioa') ?></h4>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="app-search dropdown">
                    <form method="get" >
                        <div class="input-group">
                            ...
                            <a href="<?= site_url(lang('aktivosistema.aktivoHotuProfessoresUrlPortfolio'))?>" class="btn btn-warning ms-1" style="color: white;"title="">
