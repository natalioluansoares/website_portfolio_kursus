...
<?= $this->section('administrator') ?>
    <title><?=lang('categorioPortfolio.temporarioCategorio')?></title>
<?= $this->endSection() ?>
<?= $this->section('administrator') ?>
<!-- start page title -->
<div class="mb-3"></div>
<div class="row">
    <div class="col-lg-3">
        <div class="mb-3">
            ...
            <h4 class="page-title"><?=lang('categorioPortfolio.temporarioCategorio')?></h4>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="app-search dropdown">
                    <form>
                        <div class="input-group">
                            ...
                            <a href="<?= base_url(lang('categorioPortfolio.categorioUrlPortfolio'))?>" class="btn btn-dark ms-1">
                ...
                <div class="table-responsive">
                    <table id="selection-datatable" class="table dt-responsive table-bordered nowrap w-100">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th><?= lang('categorioPortfolio.kodeCategorio') ?></th>
                                <th><?= lang('categorioPortfolio.categorioCategorio') ?></th>
                                <th><?= lang('categorioPortfolio.dataCategorio') ?></th>
                                <th><?= lang('categorioPortfolio.deleteCategorio') ?></th>
                                <th><?= lang('categorioPortfolio.updateCategorio') ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                            ...
                            <tr>
                                <td><?=$no++?></td>
                                <td><?=$portfolio->kode_categorio?></td>
                                <td><?=$portfolio->categorio?></td>
                                <td><?=$portfolio->data_categorio?></td>
...
<div class="modal fade permanentecategorio" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?=base_url(lang('categorioPortfolio.permanenteCategorioUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
...
<div class="modal fade hamoscategorio" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?=base_url(lang('categorioPortfolio.temporarioCategorioUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <center>
                        <font size="15" style="color: red;"><i class="mdi mdi-map-marker-question-outline"></i></font>
...
<div class="modal fade hamoshotucategorio" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?=base_url(lang('categorioPortfolio.hamoshotutemporarioCategorioUrlPortfolio')) ?>" method="get">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <center>
                        <font size="15" style="color: red;"><i class="mdi mdi-map-marker-question-outline"></i></font>
