...
<?= $this->section('administrator') ?>
    <title><?=lang('registoFunsionario.imageUpdatePortfolio')?></title>
<?= $this->endSection() ?>
<?= $this->section('administrator') ?>
<!-- start page title -->
<div class="mb-3"></div>
<div class="row">
    <div class="col-lg-3">
        <div class="mb-3">
            ...
            <h4 class="page-title"><?=lang('registoFunsionario.imageUpdatePortfolio')?></h4>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane show active" id="form-row-preview">
                        <form action="<?=base_url(lang('registoFunsionario.processoImageRegistoUrlConta').$administrator->id_administrator) ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="row g-2">
                                <div class="mb-3 col-md-12">
                                    <label for="inputEmail4" class="form-label"><?=lang('registoFunsionario.imageFunsionarioPortfolio')?></label>
                                    <input type="file" name="image_administrator" class="form-control mb-2 <?=isset($errors['image_administrator']) ? 'is-invalid' : null ?>" id="inputEmail4" placeholder="<?=lang('registoFunsionario.fatinEsperiensia')?>">
