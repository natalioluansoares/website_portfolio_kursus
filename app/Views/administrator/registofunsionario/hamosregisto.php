hamosFuncionariohamosFuncionarioRegistoPortfolio<?= $this->extend('templateadministrator/header') ?>

<?= $this->section('administrator') ?>
    <title><?=lang('registoFunsionario.hamosFuncionarioRegistoPortfolio')?></title>
<?= $this->endSection() ?>
<?= $this->section('administrator') ?>
<!-- start page title -->
<div class="mb-3"></div>
<div class="row">
    <div class="col-lg-3">
        <div class="mb-3">
            ...
            <h4 class="page-title"><?=lang('registoFunsionario.hamosFuncionarioRegistoPortfolio')?></h4>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="app-search dropdown">
                    <form method="get" >
                        <div class="input-group">
                            ...
                            <a href="<?= base_url(lang('registoFunsionario.registoUrlConta'))?>" class="btn btn-dark ms-1">
                                <i class="mdi mdi-skip-previous"></i>
                            </a>
                             <a href="" class="btn btn-danger ms-1 btn-animation" data-animation="flipInY" data-toggle="modal" data-target=".hamoshotufunsionario">
                ...
                <div class="table-responsive">
                    <table id="selection-datatable" class="table dt-responsive table-bordered nowrap w-100">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th><?=lang('registoFunsionario.fullNamePortfolio') ?></th>
                                <th><?=lang('registoFunsionario.statusServisuPortfolio') ?></th>
                                <th><?=lang('registoFunsionario.sexoPortfolio') ?></th>
                                <th><?=lang('registoFunsionario.numeroTelefonePortfolio') ?></th>
                                <th><?=lang('registoFunsionario.numeroEleituralPortfolio') ?></th>
                                <th><?=lang('registoFunsionario.datePortfolio') ?></th>
                                <th><?=lang('registoFunsionario.sistemaPortfolio') ?></th>
                                <th><?=lang('registoFunsionario.imagePortfolio') ?></th>
                                <th><?=lang('registoFunsionario.deletePortfolio') ?></th>
                                <th><?=lang('registoFunsionario.updatePortfolio') ?></th>
                            </tr>
                        </thead>
                        <tbody>
                            <?php 
                            ...
                            <tr>
                                ...
                                <td><?=lang('registoFunsionario.aktivoServisuFunsionario')?></td>
                                <?php }else{ ?>
                                <td><?=lang('registoFunsionario.laAktivoServisuFunsionario')?></td>
                               <?php } ?>                               
                                <?php if ($portfolio->jenero == 'Mane') { ?>
                                <td><?=lang('registoFunsionario.maneFunsionario')?></td>
                                <?php }else{ ?>
                                <td><?=lang('registoFunsionario.fetoFunsionario')?></td>
                               <?php } ?>                               
                                ...
                                <td><a href="" class="btn btn-danger btn-animation" data-animation="slideInLeft" data-toggle="modal" data-target=".permanentefunsionario" id="funsionario" 
                                data-id="<?= $portfolio->id_administrator; ?>">
                                <i class="uil-trash"></i>
                                </a></td>
                                <td><a href="" class="btn btn-warning btn-animation" data-animation="slideInRight" data-toggle="modal" data-target=".hamosfunsionario" id="funsionariotemporario" 
                                data-id="<?= $portfolio->id_administrator; ?>">
...
<div class="modal fade permanentefunsionario" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?=base_url(lang('registoFunsionario.permanenteFunsionarioUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
...
<div class="modal fade hamosfunsionario" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?=base_url(lang('registoFunsionario.temporarioFunsionarioUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <center>
                        <font size="15" style="color: red;"><i class="mdi mdi-map-marker-question-outline"></i></font>
...
<div class="modal fade hamoshotufunsionario" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?=base_url(lang('registoFunsionario.hamoshotutemporarioFunsionarioUrlPortfolio')) ?>" method="get">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <center>
                        <font size="15" style="color: red;"><i class="mdi mdi-map-marker-question-outline"></i></font>
