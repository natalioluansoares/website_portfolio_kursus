...
<?= $this->section('administrator') ?>
    <title><?=lang('registoFunsionario.registoFuncionarioPortfolio')?></title>
<?= $this->endSection() ?>
<?= $this->section('administrator') ?>
<!-- start page title -->
<div class="mb-3"></div>
<div class="row">
    <div class="col-lg-3">
        <div class="mb-3">
            ...
            <h4 class="page-title"><?=lang('registoFunsionario.registoFuncionarioPortfolio')?></h4>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="app-search dropdown">
                    <form method="get" >
                        <div class="input-group">
                            ...
                            <a href="<?=base_url(lang('registoFunsionario.hamosRegistoUrlConta')) ?>" class="btn btn-danger ms-2">
                ...
                <div class="table-responsive">
                    <table id="selection-datatable" class="table dt-responsive table-bordered nowrap w-100">
                        ...
                        <tbody>
                            ...
                            <?php if ($portfolio->sistema == 'Administrasaun' && $portfolio->aktivo_administrator == null) { ?>
                            <tr>
                                <td><?=$no++?></td>
                               ...
                               <?php } ?>                               
                                ...
                                <td><a href="<?=base_url(lang('registoFunsionario.imageRegistoUrlConta').$portfolio->id_administrator) ?>"><img alt="image" src="<?= base_url('uploads/fotoportfolio/'.$portfolio->image_administrator)?>" style="width: 100px;"></a></td>
                                <td>
                                    <a href="" class="btn btn-danger btn-animation" data-animation="flipInX" data-toggle="modal" data-target=".trokafunsionario" id="funsionario" 
                                data-id="<?= $portfolio->id_administrator; ?>">
                                <i class="uil-trash"></i>
                                </a>
                                </td>
                                <td><a href="<?=base_url(lang('registoFunsionario.trokaRegistoUrlConta').$portfolio->id_administrator) ?>" class="btn btn-success"><i class="uil-edit-alt"></i></a></td>
                            </tr>
                            <?php } ?>
                            <?php endforeach; ?>
                        </tbody>
...
<div class="modal fade trokafunsionario" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?=base_url(lang('registoFunsionario.deleteRegistoUrlConta')) ?>" method="post">
                <?= csrf_field(); ?>
