                ...
                <div class="app-search dropdown">
                    <form>
                        <div class="input-group">
                            ...
                            <a href="<?=base_url(lang('horarioProfessores.horarioPortfolioUrlPortofolio'))?>" class="btn btn-dark ms-2">
                                <i class="mdi mdi-skip-previous"></i>
                            </a>
                            <a href="<?=base_url(lang('horarioProfessores.aumentaHorarioPortfolioUrlPortfolio').$preparasaun->materia_professores)?>" class="btn btn-info ms-2">
                        ...
                        <tbody>
                            ...
                            <tr>
                               ...
                               <?php } ?>
                                ...
                                <td align="center"><small><strong><?=$portfolio->total_estudante ?></strong></small></td>
                                ...
                                <td align="center"><a href="<?=base_url(lang('horarioProfessores.trokaHorarioPortfolioUrlPortfolio').$portfolio->materia_professores.'/'.$portfolio->id_horario) ?>" class="btn btn-success"><i class="uil-edit-alt"></i></a></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
