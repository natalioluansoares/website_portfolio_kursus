...
<div class="row">
    <div class="col-lg-3">
        <div class="mb-3">
            ...
            <h4 class="page-title"><?=lang('sidebarPortfolio.trokahorarioPortfolio')?></h4>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane show active" id="form-row-preview">
                        <form action="<?=base_url(lang('horarioProfessores.updateHorarioPortfolioUrlPortfolio').$horario->id_horario) ?>" method="post">
                            <?= csrf_field(); ?>
                            <div class="row g-2">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <select id="inputState" name="materia_horario" class="form-control">
                                        <option value="<?=$horario->materia_horario ?>"><?=$horario->materia?>(<sub><?=$horario->kode_materia_professores?></sub>)(<sub><?=$horario->level_materia_professores?></sub>)</option>
                                        <option value=""><?=lang('horarioProfessores.hiliMateriaMateria')?></option>
                                        <?php foreach($preparasaun as $pro): ?>
                                        <option value="<?=$pro->id_preparasaun_materia ?>"<?= old('materia_horario') == $pro->id_preparasaun_materia  ? 'selected' : null ?>><?=$pro->materia?>(<sub><?=$pro->kode_materia_professores?></sub>)(<sub><?=$pro->level_materia_professores?></sub>)</option>
                                        <?php endforeach; ?>
                                    </select>
                                    <small class="text-danger">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="date" name="data_horario_hahu" value="<?=old('data_horario_hahu', $horario->data_horario_hahu) ?>" class="form-control"  placeholder="<?=date('Y-M-d')?>">
                                    <small class="text-danger">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="date" name="data_horario_remata" value="<?=old('data_horario_remata', $horario->data_horario_remata) ?>" class="form-control" placeholder="<?=date('Y-M-d')?>">
                                    <small class="text-danger">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="time" name="horas_tama_kursus"  value="<?=old('horas_tama_kursus', $horario->horas_tama_kursus) ?>" class="form-control" placeholder="<?=lang('horarioProfessores.orasHahuHorario')?>">
                                    <small class="text-danger">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="time" name="horas_sai_kursus" value="<?=old('horas_sai_kursus', $horario->horas_sai_kursus) ?>" class="form-control" placeholder="<?=lang('horarioProfessores.orasRemataHorario')?>">
                                    <small class="text-danger">
                                ...
                                <div class="mb-3 col-md-4">
                                    <label for="inputPassword4" class="form-label"><?=lang('horarioProfessores.orasRemataHorario')?></label>
                                    <input type="number" name="osan_kursus" min="0" value="<?=old('osan_kursus', $horario->osan_kursus) ?>" class="form-control" placeholder="<?=lang('horarioProfessores.orasRemataHorario')?>">
                                    <small class="text-danger">
