...
<div class="row">
    <div class="col-lg-3">
        <div class="mb-3">
            ...
            <h4 class="page-title"><?=lang('sidebarPortfolio.horarioPortfolio')?></h4>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <div class="card-footer text-center border-0 mt-0">								
                            <a href="<?=base_url(lang('horarioProfessores.showHorarioPortfolioUrlPortfolio').$portfolio->id_professores) ?>" class="btn btn-primary btn-rounded px-2" style="color:aliceblue"><i class="mdi mdi-folder-open"></i></a>
                            <a href="<?=base_url(lang('horarioProfessores.showHorarioPortfolioUrlPortfolio').$portfolio->id_professores) ?>" class="btn btn-danger btn-rounded px-2"><i class="uil-trash"></i></a>
                        </div>
                    </div>
                </div>
            </div>
