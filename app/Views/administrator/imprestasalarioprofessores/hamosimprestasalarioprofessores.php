                ...
                <div class="app-search dropdown">
                    <form>
                        <div class="input-group">
                            ...
                            <a href="<?= base_url(lang('imprestaSalarioProfessores.showImprestaSalarioProfessoresPortfolioUrlPortfolio').$salario->id_salario_professores)?>" class="btn btn-dark ms-1">
                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <?php } ?>
                                ...
                                data-id="<?= $portfolio->id_osan_impresta_professores; ?>">
                                <i class="uil-trash"></i>
                                </a>
                                </td>
                                ...
                                data-id="<?= $portfolio->id_osan_impresta_professores; ?>" data-total="<?= $portfolio->total_osan_impresta; ?>" data-osan="<?= $portfolio->osan_impresta_professores ; ?>">
...
<div class="modal fade permanenteimpresta" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?=base_url(lang('imprestaSalarioProfessores.permanenteImprestaSalarioProfessoresPortfolioUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
...
<div class="modal fade hamosimpresta" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?=base_url(lang('imprestaSalarioProfessores.temporarioImprestaSalarioProfessoresPortfolioUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <center>
                        <font size="15" style="color: red;"><i class="mdi mdi-map-marker-question-outline"></i></font>
                        ...
                        <input type="hidden" name="osan_impresta_professores" id="osan" placeholder="Kategori"class="form-control">
...
<script>
    ...
    $(".permanenteimpresta #idhamoshotu").val(Id);
})
</script>
<script>
