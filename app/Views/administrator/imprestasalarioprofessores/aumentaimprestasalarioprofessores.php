...
<?= $this->section('administrator') ?>
    <title><?=lang('sidebarPortfolio.aumentaImprestaSalarioProfessoresPortfolio')?></title>
<?= $this->endSection() ?>
<?= $this->section('administrator') ?>
<!-- start page title -->
<div class="mb-3"></div>
<div class="row">
    <div class="col-lg-3">
        <div class="mb-3">
            ...
            <h4 class="page-title"><?=lang('sidebarPortfolio.aumentaImprestaSalarioProfessoresPortfolio')?></h4>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane show active" id="form-row-preview">
                        <form action="<?=base_url(lang('imprestaSalarioProfessores.inputImprestaSalarioProfessoresPortfolioUrlPortfolio')) ?>" method="post">
                            <?= csrf_field(); ?>
                            <div class="row g-2">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="number" name="total_osan_impresta" min="0" class="form-control" value="<?=old('total_osan_impresta')?>" id="inputEmail4" placeholder="<?=lang('imprestaSalarioProfessores.totalFunsionario')?>">
                                    <small class="text-danger">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="date" name="data_osan_impresta"  class="form-control"  value="<?=old('data_osan_impresta')?>"  placeholder="<?=lang('imprestaSalarioProfessores.dataFunsionario')?>">
                                    <small class="text-danger">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="time" name="horas_osan_impresta" min="0" class="form-control" value="<?=old('horas_osan_impresta')?>"  placeholder="<?=lang('imprestaSalarioProfessores.horasFunsionario')?>">
                                    <small class="text-danger">
                            ...
                            <a href="<?= base_url(lang('imprestaSalarioProfessores.showImprestaSalarioProfessoresPortfolioUrlPortfolio').$row->id_salario_professores)?>" class="btn btn-info ms-1"><i class="mdi mdi-skip-previous"></i></a>
                        </form>                     
                    </div> <!-- end preview-->
                </div> <!-- end preview-->
            </div> <!-- end card-body-->
