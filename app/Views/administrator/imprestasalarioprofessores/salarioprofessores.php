...
<?= $this->section('administrator') ?>
    <title><?=lang('imprestaSalarioProfessores.hiliFunsionario')?></title>
<?= $this->endSection() ?>
<?= $this->section('administrator') ?>
<!-- start page title -->
<div class="mb-3"></div>
<div class="row">
    <div class="col-lg-3">
        <div class="mb-3">
            ...
            <h4 class="page-title"><?=lang('imprestaSalarioProfessores.hiliFunsionario')?></h4>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="col-lg-12">
                    <div class="card">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item d-flex justify-content-between"><span class="mb-0"><?=lang('professoresPortfolio.statusServisuPortfolio') ?></span> <strong class="text-muted">
                        ...
                        <div class="card-footer text-left border-0 mt-0">								
                            <a href="<?=base_url(lang('imprestaSalarioProfessores.showImprestaSalarioProfessoresPortfolioUrlPortfolio').$portfolio->id_salario_professores) ?>"
                            class="btn btn-dark btn-rounded px-2"><i class=" uil-folder-plus"></i></a>
                            <a href="<?=base_url(lang('imprestaSalarioProfessores.hamosImprestaSalarioProfessoresPortfolioUrlPortfolio').$portfolio->id_salario_professores) ?>" class="btn btn-warning btn-rounded px-2"><i class="mdi mdi-broom"></i></a>
                        </div>
                    </div>
                </div>
            </div>
