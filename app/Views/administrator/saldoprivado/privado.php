                        ...
                        <center>
                            <table>
                                <thead>
                                    <tr>
                                        <th>
                                            <a href="" class="btn btn-danger btn-animation" data-animation="rubberBand" data-toggle="modal" data-target=".trokaprivado" id="privado" 
                                            data-id="<?= $portfolio->id_saldo_privado; ?>">
                                            <i class="uil-trash"></i>
                                            </a>
                                        </th>
                                        <th>
                                            <a href="<?=base_url(lang('saldoprivadoPortfolio.trokaSaldoPrivadoUrlPortfolio').$portfolio->id_saldo_privado) ?>" class="btn btn-success"><i class="uil-edit-alt"></i></a>
                                        </th>
                                        <th>
                                            <a href="<?=base_url(lang('saldoprivadoPortfolio.trokaSaldoPrivadoImageUrlPortfolio').$portfolio->id_saldo_privado) ?>" class="btn btn-info"><i class="mdi mdi-image-multiple"></i></a>
                                        </th>
                                    </tr>
                                </thead>
                            </table>
            ...
            <form action="<?=base_url(lang('saldoprivadoPortfolio.deleteSaldoPrivadoUrlPortfolio')) ?>" method="post">
                ...
                <div class="modal-body">
                    <center>
                        ...
                        <input type="hidden" name="aktivo_saldo_privado" value="1" placeholder="Kategori"class="form-control">
                    </center>
                    <center>
