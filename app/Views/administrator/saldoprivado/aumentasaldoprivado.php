            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane show active" id="form-row-preview">
                        <form action="<?=base_url(lang('saldoprivadoPortfolio.inputSaldoPrivadoUrlPortfolio')) ?>" method="post" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
                            <div class="row g-2">
                                <div class="mb-3 col-md-6">
                                    <label for="inputEmail4" class="form-label"><?=lang('saldoprivadoPortfolio.kodeSaldo')?></label>
                                    <input type="text" name="kode_saldo_privado" value="<?=old('kode_saldo_privado') ?>" class="form-control <?=isset($errors['kode_saldo_privado']) ? 'is-invalid' : null ?>" id="kode_saldo_portfolio" placeholder="<?=lang('saldoprivadoPortfolio.kodeSaldo')?>">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="text" name="naran_organizasaun_privado" value="<?=old('naran_organizasaun_privado') ?>" class="form-control <?=isset($errors['naran_organizasaun_privado']) ? 'is-invalid' : null ?>" id="inputPassword4" placeholder="<?=lang('saldoprivadoPortfolio.organizasaunSaldo')?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="date" name="data_saldo_privado" value="<?=old('data_saldo_privado') ?>" class="form-control <?=isset($errors['data_saldo_privado']) ? 'is-invalid' : null ?>" id="inputPassword4" placeholder="<?=lang('saldoprivadoPortfolio.dataSaldo')?>">
                                    <div class="invalid-feedback">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="file" name="foto_privado" value="<?=old('saldo_portfolio') ?>" class="form-control <?=isset($errors['foto_privado']) ? 'is-invalid' : null ?>" id="inputPassword4" placeholder="<?=lang('saldoprivadoPortfolio.fotoSaldo')?>">
                                    <div class="invalid-feedback">
                            ...
                            <div class="row g-2">
                                <div class="mb-3 col-md-12">
                                    ...
                                    <textarea name="descripsaun_saldo_privado" id="" cols="30" class="form-control <?=isset($errors['descripsaun_saldo_privado']) ? 'is-invalid' : null ?>" rows="10"><?=old('descripsaun_saldo_privado')?></textarea>
                                    <div class="invalid-feedback">
