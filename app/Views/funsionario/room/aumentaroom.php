    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><strong><?=lang('sidebarPortfolio.aumentaAulaPortfolio')?></strong></h4>
            </div>
            <?php $errors = session()->getFlashdata('errors'); ?>
            <div class="card-body">
                <div class="basic-form">
                    <form action="<?=base_url(lang('roomFunsionario.inputRoomFunsionarioUrlPortfolio')) ?>" method="post">
                        <?= csrf_field(); ?>
                        <div class="row g-2">
                            <div class="mb-3 col-md-4">
                                <label for="inputEmail4" class="form-label"><?=lang('classePortfolio.kodeClasse')?></label>
                                <input type="text" name="kode_classe" value="<?=old('kode_classe') ?>" class="form-control" id="inputEmail4" placeholder="<?=lang('classePortfolio.kodeClasse')?>">
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="text" name="classe" value="<?=old('classe') ?>" class="form-control" id="inputPassword4" placeholder="<?=lang('classePortfolio.classeClasse')?>">
                                <small class="text-danger">
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="text" name="data_classe" value="<?=old('data_classe') ?>" class="form-control" id="mdate" placeholder="<?=date('Y-M-d')?>">
                                <small class="text-danger">
