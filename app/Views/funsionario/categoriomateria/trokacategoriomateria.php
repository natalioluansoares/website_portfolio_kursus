        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="basic-form">
                    <form action="<?=base_url(lang('sciensieCategoryFunsionario.updateSciensieCategoryFunsionarioUrlPortfolio').$categorio->id_categorio) ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="row g-2">
                            <div class="mb-3 col-md-4">
                                <label for="inputEmail4" class="form-label"><?=lang('categorioPortfolio.kodeCategorio')?></label>
                                <input type="text" name="kode_categorio" value="<?= old('kode_categorio', $categorio->kode_categorio) ?>" class="form-control" id="inputEmail4" placeholder="<?=lang('categorioPortfolio.kodeCategorio')?>">
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="text" name="categorio" value="<?= old('categorio', $categorio->categorio) ?>" class="form-control" id="inputPassword4" placeholder="<?=lang('categorioPortfolio.categorioCategorio')?>">
                                <small class="text-danger">
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="date" name="data_categorio" value="<?= old('data_categorio',$categorio->data_categorio) ?>" class="form-control" id="inputPassword4" placeholder="<?=lang('categorioPortfolio.dataCategorio')?>">
                                <small class="text-danger">
                            ...
                            <div class="mb-3 col-md-12">
                                ...
                                <textarea name="descripsaun_categorio" class="form-control" id="" cols="30" rows="10"><?= old('descripsaun_categorio',$categorio->descripsaun_categorio) ?></textarea>
                                <small class="text-danger">
