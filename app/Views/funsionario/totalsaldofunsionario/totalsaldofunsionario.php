    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><strong><?=lang('saldoPortfolio.totalSaldo')?></strong></h4>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-responsive-sm">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center"><?=lang('saldoPortfolio.totalSaldo') ?></th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php if ($portfolio->total_saldo_portfolio == null) { ?>
                                    <td align="center"><strong><small class="text-center"><span class="badge badge-danger"><?=lang('saldoPortfolio.mamukSaldo') ?></span></small></strong></td>
                                <?php }else { ?>
                                    <td align="center"><strong><span class="badge badge-success">$ <?=number_format($portfolio->total_saldo_portfolio,2)?></span></strong></td>
                              <?php } ?>
