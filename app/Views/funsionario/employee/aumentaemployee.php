        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="basic-form">
                    <form action="<?=base_url(lang('employeeFunsionario.inputEmployeeUrlPortfolio')) ?>" method="post">
                        <?= csrf_field(); ?>
                        <div class="row g-2">
                            <div class="mb-3 col-md-6">
                                <label for="inputEmail4" class="form-label"><?=lang('funsionarioPortfolio.tituloFunsionario')?></label>
                                <input type="text" name="titulo_funsionario" class="form-control" id="inputEmail4" placeholder="<?=lang('funsionarioPortfolio.tituloFunsionario')?>">
                        ...
                        <a href="<?= base_url(lang('employeeFunsionario.employeeUrlPortofolio'))?>" class="btn btn-info ms-1"><i class="mdi mdi-skip-previous"></i></a>
                    </form> 
                </div>
            </div>
        </div>
