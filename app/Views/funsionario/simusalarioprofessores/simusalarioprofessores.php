...
<?php if ($acesso->simu_salario_professores == 1 && $acesso->menu_finansa ==1) {?>
<div class="row">
    <div class="col-lg-8">
        <div class="mb-3">
                    ...
                    <form>
                        <div class="input-group">
                            ...
                            <?php if ($acesso->aumenta_direito_acesso_autromos == 1 && $acesso->simu_salario_professores ==1 && $acesso->menu_finansa == 1): ?>
                                <a href="<?= base_url(lang('salarioProfessores.aumentaSimuSalarioProfessoresUrl').$salario->id_salario_professores) ?>" class="btn" style="background-color: darkslateblue; color:aliceblue"><i class="fa fa-plus"></i></a>
                            <?php endif; ?>
                        </div>
                    </form>
                </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><strong><?=lang('sidebarPortfolio.simuSalarioProfessores')?></strong></h4>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            ...
                            <th>No</th>
                                ...
                                <?php if ($acesso->hamos_direito_acesso_autromos == 1 && $acesso->simu_salario_professores ==1 && $acesso->menu_finansa == 1): ?>
                                    <th><?=lang('salarioFunsionario.hamosFunsionario') ?></th>
                                <?php endif; ?>
                                <?php if ($acesso->troka_direito_acesso_autromos == 1 && $acesso->simu_salario_professores ==1 && $acesso->menu_finansa == 1): ?>
                        ...
                        <?php 
                            ...
                            <tr>
                              ...
                              <?php } ?>
                                ...
                                <?php endif; ?>
                                <?php if ($acesso->troka_direito_acesso_autromos == 1 && $acesso->simu_salario_professores ==1 && $acesso->menu_finansa == 1): ?>
                                <td align="center"><a href="<?=base_url(lang('salarioProfessores.editSimuSalarioProfessoresUrl').$portfolio->id_salario_simu_professores.'/'.$portfolio->salario_simu_professores) ?>" class="btn btn-success"><i class="fa fa-pencil"></i></a></td>
                                <?php endif; ?>
                            </tr>
                            <?php
...
<div class="modal fade trokasimusalario" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?=base_url(lang('salarioProfessores.trokaSimuSalarioProfessoresUrl')) ?>" method="post">
                <?= csrf_field(); ?>
