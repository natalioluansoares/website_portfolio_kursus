...
<?= $this->section('funsionario') ?>
    <title><?=lang('sidebarPortfolio.trokaSimuSalarioProfessores')?></title>
<?= $this->endSection() ?>
<?= $this->section('funsionario') ?>
...
<div class="row">
    <div class="col-lg-3">
        <div class="mb-3">
            ...
            <h4 class="page-title"><?=lang('sidebarPortfolio.trokaSimuSalarioProfessores')?></h4>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane show active" id="form-row-preview">
                        <form action="<?=base_url(lang('salarioProfessores.updateSimuSalarioProfessoresUrl').$simusalario->id_salario_simu_professores ) ?>" method="post">
                            <?= csrf_field(); ?>
                            <div class="row g-2">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="text" name="data_salario_simu_professores" id="start"  class="form-control <?=isset($errors['data_salario_simu_professores']) ? 'is-invalid' : null ?>"  value="<?=old('data_salario_simu_professores', $simusalario->data_salario_simu_professores)?>"  placeholder="<?=lang('salarioFunsionario.dataFunsionario')?>">
                                    <small class="text-danger">
                                ...
                                <div class="mb-3 col-md-4 clockpicker">
                                    ...
                                    <input type="text" name="horas_salario_simu_professores" class="form-control <?=isset($errors['horas_salario_simu_professores']) ? 'is-invalid' : null ?>" value="<?=old('horas_salario_simu_professores', $simusalario->horas_salario_simu_professores)?>"  placeholder="<?=lang('salarioFunsionario.horasFunsionario')?>">
                                    <small class="text-danger">
