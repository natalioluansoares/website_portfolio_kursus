...
<?= $this->section('funsionario') ?>
    <title><?=lang('sidebarPortfolio.horarioPortfolio')?></title>
<?= $this->endSection() ?>
<?= $this->section('funsionario') ?>
...
<div class="row">
    <div class="col-lg-4">
        <div class="mb-3">
            <h4 class="card-title"><strong><?=lang('sidebarPortfolio.horarioPortfolio')?></strong></h4>
        </div>
    </div>
</div>
                ...
                <div class="card">
                    ...
                    <div class="card-footer text-center border-0 mt-0">	
                        <?php if ($acesso->aumenta_direito_acesso_autromos == 1 && $acesso->horario_kursus == 1 && $acesso->menu_classe_horario == 1) {?>							
                            <a href="<?=base_url(lang('horarioProfessores.aumentaHorarioFunsionarioUrlPortfolio').$portfolio->id_professores) ?>" class="btn btn-success btn-rounded px-3"><i class="fa fa-plus"></i></a>
                        <?php } ?>
                        <a href="<?=base_url(lang('horarioProfessores.showHorarioFunsionarioUrlPortfolio').$portfolio->id_professores) ?>" class="btn btn-primary btn-rounded px-3" style="background-color: darkslateblue; color:aliceblue"><i class="fa fa-folder-open"></i></a>
                    </div>
                </div>
            </div>
        </div>
