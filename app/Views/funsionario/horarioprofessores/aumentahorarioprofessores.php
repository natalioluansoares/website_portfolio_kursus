    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><?=lang('sidebarPortfolio.aumentahorarioPortfolio')?></strong></h4>
            </div>
            <?php $errors = session()->getFlashdata('errors'); ?>
            <div class="card-body">
                <div class="basic-form">
                    <form action="<?=base_url(lang('horarioProfessores.inputHorarioFunsionarioUrlPortfolio')) ?>" method="post">
                        <?= csrf_field(); ?>
                        <div class="row g-2">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" name="data_horario_hahu" value="<?=old('data_horario_hahu') ?>" class="form-control" id="start" placeholder="<?=date('Y-M-d')?>">
                                <small class="text-danger">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" name="data_horario_remata" value="<?=old('data_horario_remata') ?>" class="form-control" id="end" placeholder="<?=date('Y-M-d')?>">
                                <small class="text-danger">
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="text" name="horas_tama_kursus" id="startpicker" value="<?=old('horas_tama_kursus') ?>" class="form-control" placeholder="<?=lang('horarioProfessores.orasHahuHorario')?>">
                                <small class="text-danger">
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="text" name="horas_sai_kursus" id="finishpicker" value="<?=old('horas_sai_kursus') ?>" class="form-control" placeholder="<?=lang('horarioProfessores.orasRemataHorario')?>">
                                <small class="text-danger">
