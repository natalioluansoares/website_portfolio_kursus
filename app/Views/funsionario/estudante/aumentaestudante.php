...
<?= $this->section('funsionario') ?>
    <title><?=lang('sidebarPortfolio.aumentaEstudantePortfolio')?></title>
<?= $this->endSection() ?>
<?= $this->section('funsionario') ?>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><strong><?=lang('sidebarPortfolio.aumentaEstudantePortfolio')?></strong></h4>
            </div>
            <?php $errors = session()->getFlashdata('errors'); ?>
            <div class="card-body">
                <div class="basic-form">
                    <form action="<?=base_url(lang('registuEstudanteFunsionario.inputEstudanteRegistoUrlPortfolio')) ?>" method="post">
                            <?= csrf_field(); ?>
                            <div class="row g-2">
                                ...
                                <div class="mb-3 col-md-6">
                                    ...
                                    <input type="date" name="data_estudante_registo" class="form-control" id="inputEmail4" placeholder="<?=lang('funsionarioPortfolio.tituloFunsionario')?>">
                                    <small class="text-danger">
