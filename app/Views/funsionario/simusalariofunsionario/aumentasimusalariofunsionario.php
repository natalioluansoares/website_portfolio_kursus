...
<?= $this->section('funsionario') ?>
    <title><?=lang('sidebarPortfolio.aumentaSimuSalarioFunsionario')?></title>
<?= $this->endSection() ?>
<?= $this->section('funsionario') ?>
...
<?php if ($acesso->aumenta_direito_acesso_autromos == 1 && $acesso->simu_salario_funsionario ==1 && $acesso->menu_finansa == 1) {?>
<div class="row">
    <div class="col-lg-3">
        <div class="mb-3">
            <div class="page-title-right">
            <h4 class="page-title"><?=lang('sidebarPortfolio.aumentaSimuSalarioFunsionario')?></h4>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="card-body">
                <div class="tab-content">
                    ...
                    <div class="tab-pane show active" id="form-row-preview">
                        <form action="<?=base_url(lang('salarioFunsionario.createSimuSalarioFunsionarioUrl')) ?>" method="post">
                            <?= csrf_field(); ?>
                            <div class="row g-2">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="text" name="data_salario_simu_funsionario" id="start"  class="form-control <?=isset($errors['data_salario_simu_funsionario']) ? 'is-invalid' : null ?>"  value="<?=old('data_salario_simu_funsionario')?>"  placeholder="<?=lang('salarioFunsionario.dataFunsionario')?>">
                                    <small class="text-danger">
                                ...
                                <div class="mb-3 col-md-4 clockpicker">
                                    ...
                                    <input type="text" name="horas_salario_simu_funsionario" class="form-control <?=isset($errors['horas_salario_simu_funsionario']) ? 'is-invalid' : null ?>" value="<?=old('horas_salario_simu_funsionario')?>"  placeholder="<?=lang('salarioFunsionario.timeFunsionario')?>">
                                    <small class="text-danger">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <select id="inputState" name="salario_osan_sai" class="form-control <?=isset($errors['salario_osan_sai']) ? 'is-invalid' : null ?>">
                                        ...
                                        <?php if ($pro->aktivo_osan_sai == null) { ?>
                                            <option value="<?=$pro->id_osan_sai?>"<?= old('salario_osan_sai') == $pro->id_osan_sai ? 'selected' : null ?>><?=$pro->naran_osan_sai?>($ <?= number_format($pro->total_osan_sai, 2)?>)</option>
                                        <?php }else{ ?>
