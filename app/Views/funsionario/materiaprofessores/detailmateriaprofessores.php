            ...
            <div class="page-title-right">
                <div class="table-responsive">
                    <form class="d-flex">
                        ...
                        <a href="<?= base_url(lang('materiaProfessores.materiaProfessoresUrlPortfolio'))?>" class="btn btn-dark ms-1"><i class="mdi mdi-skip-previous"></i></a>
                    </form>
                </div>
            </div>
        </div>
                ...
                <div class="app-search dropdown">
                    <form>
                        <div class="input-group">
                            ...
                            <?php if($acesso->aumenta_direito_acesso_autromos == 1 && $acesso->materia_professores == 1 && $acesso->menu_profesores == 1) { ?>
                            <a href="<?= base_url(lang('materiaProfessores.aumentaMateriaProfessoresUrlPortfolio').$professores->id_professores) ?>" class="btn" style="background-color: darkslateblue; color:aliceblue"><i class="fa fa-plus"></i></a>
                            <?php } ?>
                        </div>
                    </form>
                </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><strong><?=lang('sidebarPortfolio.detailMateriaProfessoresPortfolio')?></strong></h4>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <?php if($acesso->hamos_direito_acesso_autromos == 1 && $acesso->materia_professores == 1 && $acesso->menu_profesores == 1) { ?>
                                    <th><?=lang('materiaProfessores.hamosMateria') ?></th>
                               <?php } ?>
                               <?php if ($acesso->troka_direito_acesso_autromos == 1 && $acesso->materia_professores == 1 && $acesso->menu_profesores == 1) {?>
                                    <th><?=lang('materiaProfessores.trokaMateria') ?></th>
                               <?php } ?>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"><a href="<?=base_url(lang('preparasaunMateria.preparasaunPreparasaunMateriaUrlPortfolio').$portfolio->id_materia_professores) ?>"><strong><small class="text-center"><span class="badge badge-success"><?=$portfolio->level_materia_kursus ?></span></small></strong></a></td>

                                <td align="center"><strong><small class="text-center"><span class="badge badge-info">$ <?=number_format($portfolio->preso_materia_kursus, 2) ?></span></small></strong></td>
                                ...
                                <?php } ?>
                                <?php if($acesso->troka_direito_acesso_autromos == 1 && $acesso->materia_professores == 1 && $acesso->menu_profesores == 1) { ?>
                                    <td><a href="<?=base_url(lang('materiaProfessores.trokaMateriaProfessoresUrlPortfolio').$portfolio->materia_professores.'/'.$portfolio->id_materia_professores) ?>" class="btn btn-success"><i class="fa fa-pencil"></i></a></td>
                                <?php } ?>
...
<div class="modal fade trokamateriaprofessores" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?=base_url(lang('materiaProfessores.deleteMateriaProfessoresUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
