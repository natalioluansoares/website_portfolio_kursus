    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><strong><?=lang('sidebarPortfolio.aumentaImprestaSalarioProfessoresPortfolio')?></strong></h4>
            </div>
            <?php $errors = session()->getFlashdata('errors'); ?>
            <div class="card-body">
                <div class="basic-form">
                    <form action="<?=base_url(lang('imprestaSalarioProfessores.inputImprestaSalarioProfessoresUrlPortfolio')) ?>" method="post">
                        <?= csrf_field(); ?>
                        <div class="row g-2">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" name="data_osan_impresta"  class="form-control"  value="<?=old('data_osan_impresta')?>" id="mdate" placeholder="<?=lang('imprestaSalarioProfessores.dataFunsionario')?>">
                                <small class="text-danger">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" name="horas_osan_impresta" min="0" class="form-control" value="<?=old('horas_osan_impresta')?>" id="startpicker" placeholder="<?=lang('imprestaSalarioProfessores.horasFunsionario')?>">
                                <small class="text-danger">
