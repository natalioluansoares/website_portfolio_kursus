                ...
                <div class="app-search dropdown">
                    <form>
                        <div class="input-group">
                            ...
                            <?php if ($acesso->aumenta_direito_acesso_autromos == 1 && $acesso->osan_impresta_professores == 1 && $acesso->menu_finansa == 1) :?>
                            <a href="<?= base_url(lang('imprestaSalarioProfessores.aumentaImprestaSalarioProfessoresUrlPortfolio')) ?>" class="btn" style="background-color: darkslateblue; color:aliceblue"><i class="fa fa-plus"></i></a>
                            <?php endif; ?>
                        </div>
                    </form>
                </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><strong><?=lang('sidebarPortfolio.imprestasalarioProfessoresPortfolio')?></strong></h4>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <?php endif;?>
                                <?php if ($acesso->hamos_direito_acesso_autromos == 1 && $acesso->osan_impresta_professores == 1 && $acesso->menu_finansa == 1) :?>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php if ($portfolio->sistema == 'Professores') {?>
                                    <td align="center"><span class="badge" style="background-color: rebeccapurple;color:aliceblue;"><?=lang('imprestaSalarioProfessores.professoresFunsionario') ?></span></td>
                                <?php } ?>
                                <?php if ($portfolio->total_salario == 0) { ?>
                                    <td align="center"><strong><small class="text-center"><span class="badge badge-danger"><?=lang('imprestaSalarioProfessores.salarioMamuk') ?></span></small></strong></td>
                                <?php }else { ?>
                              ...
                              <?php } ?>
                                ...
                                <?php endif; ?>
                                <?php if ($acesso->hamos_direito_acesso_autromos == 1 && $acesso->osan_impresta_professores == 1 && $acesso->menu_finansa == 1) :?>
                                    <td align="center"><a href="<?=base_url(lang('imprestaSalarioProfessores.trokaImprestaSalarioProfessoresUrlPortfolio').$portfolio->id_osan_impresta_professores) ?>" class="btn btn-success"><i class="fa fa-pencil"></i></a></td>
                                <?php endif; ?>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<div class="modal fade trokaimpresta" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?=base_url(lang('imprestaSalarioProfessores.deleteImprestaSalarioProfessoresUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
