...
<?= $this->section('funsionario') ?>
    <title><?=lang('sidebarPortfolio.exametextePortfolio')?></title>
<?= $this->endSection() ?>
<?= $this->section('funsionario') ?>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td align="center"><a href="<?=base_url(lang('valoresEstudanteFunsionario.detailValoresEstudanteFunsionarioUrlPortofolio').$portfolio->id_horario_estudante.'/'.$portfolio->data_horario_estudante) ?>" class="badge badge-success"><i class="fa fa-folder-open"></i></a></td>
                                <?php } ?>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<div class="row">
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><strong><?=lang('sidebarPortfolio.exametextePortfolio')?></strong></h4>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered">
...
<div class="modal fade exametexte" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?=base_url(lang('valoresEstudanteFunsionario.processotexteexameValoresEstudanteFunsionarioUrlPortofolio')) ?>" method="post">
                    <?= csrf_field(); ?>
                    <div class="row g-2">
...
<div class="modal fade temporariovalores" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url(lang('valoresEstudanteFunsionario.temporarioexametexteValoresEstudanteFunsionarioUrlPortofolio')) ?>" method="get">
                <?= csrf_field(); ?>
                <div class="modal-body">
                    <center>
