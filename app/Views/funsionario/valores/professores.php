            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-footer text-center border-0 mt-0">
                            <a href="<?=base_url(lang('valoresEstudanteFunsionario.showValoresEstudanteFunsionarioUrlPortofolio').$portfolio->id_professores) ?>"
                            class="btn btn-success btn-rounded px-3"><i class="fa fa-folder-open"></i></a>
                    </div>
                </div>
            </div>
        </div>
