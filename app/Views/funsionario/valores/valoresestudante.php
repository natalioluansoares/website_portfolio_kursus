            ...
            <div class="page-title-right">
                <div class="table-responsive">
                    <form class="d-flex">
                        ...
                        <a href="<?=base_url(lang('valoresEstudanteFunsionario.showValoresEstudanteFunsionarioUrlPortofolio').$horario->id_professores) ?>" class="btn btn-dark ms-1"><i class="mdi mdi-skip-previous"></i></a>
                    </form>
                </div>
            </div>
        </div>
...
<div class="row">
    <div class="col-lg-8">
        <div class="mb-3">
            <div class="page-title-right">
                <a href="<?=base_url(lang('valoresEstudanteFunsionario.trabalhoValoresEstudanteFunsionarioUrlPortofolio').$horario->data_horario_hahu.'/'.$horario->data_horario_remata.'/'.$horario->id_horario.'/'.$horario->materia_kursus.'/'.$horario->level_materia_kursus) ?>" class="btn btn-info text-white"><i class="fa fa-folder-open" aria-hidden="true"></i></a>

                <a href="<?=base_url(lang('valoresEstudanteFunsionario.texteexameValoresEstudanteFunsionarioUrlPortofolio').$horario->data_horario_hahu.'/'.$horario->data_horario_remata.'/'.$horario->id_horario.'/'.$horario->materia_kursus.'/'.$horario->level_materia_kursus) ?>" title="<?=lang('horarioProfessores.trabalhoMateria') ?>" class="btn btn-success text-white"><i class="fa fa-folder-open" aria-hidden="true"></i></a>

                <?php if ($acesso->absence == 1 && $acesso->menu_estudante == 1) {?>
                <a href="<?=base_url(lang('valoresEstudanteFunsionario.absensiEstudanteFUnsionarioUrlPortofolio').$horario->data_horario_hahu.'/'.$horario->data_horario_remata.'/'.$horario->id_horario.'/'.$horario->materia_kursus.'/'.$horario->level_materia_kursus) ?>" class="btn btn-warning text-white"><i class="fa fa-book"></i></a>
                <?php } ?>
            </div>
        </div>
    </div>
                        ...
                        <tbody>
                            ...
                            <tr>
                               ...
                               <?php } ?>
                                ...
                                <td align="center"><a href="<?=base_url(lang('valoresEstudanteFunsionario.detailvaloresestudanteValoresEstudanteFunsionarioUrlPortofolio').$portfolio->data_horario_hahu.'/'.$portfolio->data_horario_remata.'/'.$portfolio->id_horario_estudante.'/'.$portfolio->materia_kursus.'/'.$portfolio->level_materia_kursus) ?>" class="badge badge-success"><i class="fa fa-folder-open"></i></a></td>

                                <?php if ($acesso->absence == 1 && $acesso->menu_estudante == 1) {?>
                                <td><a href="<?=base_url(lang('valoresEstudanteFunsionario.detailAbsensiEstudanteFUnsionarioUrlPortofolio').$portfolio->data_horario_hahu.'/'.$portfolio->data_horario_remata.'/'.$portfolio->id_horario_estudante.'/'.$portfolio->materia_kursus.'/'.$portfolio->level_materia_kursus) ?>" class="badge badge-dark"><i class="fa fa-folder-open"></i></a></td>
                                <?php } ?>
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th><small><strong><?=lang('horarioProfessores.dataMateria') ?></strong></small></th>
                                <th><small><strong><?=lang('horarioProfessores.detailsvalueMateria') ?></strong></small></th>
                                <?php if ($acesso->absence == 1 && $acesso->menu_classe_horario == 1) {?>
                                <th><small><strong><?=lang('valoresEstudanteFunsionario.absensiEstudante') ?></strong></small></th>
                                <?php } ?>
                        </thead>
                        <tbody>
