                ...
                <div class="app-search dropdown">
                    <form>
                        <div class="input-group">
                            ...
                            <a href="<?= base_url(lang('valoresEstudanteFunsionario.valoresEstudanteFunsionarioUrlPortofolio'))?>" class="btn btn-dark ms-1"><i class="mdi mdi-skip-previous"></i></a>
                    ...
                    <table class="table table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th><small><strong><?=lang('horarioProfessores.detailMateria') ?></strong></small></th>
                        </thead>
                        <tbody>
                            <?php 
                            ...
                            <tr>
                               ...
                               <?php } ?>
                                ...
                                <td><a href="<?=base_url(lang('valoresEstudanteFunsionario.detailValoresEstudanteFunsionarioUrlPortofolio').$portfolio->data_horario_hahu.'/'.$portfolio->data_horario_remata.'/'.$portfolio->id_horario.'/'.$portfolio->materia_kursus.'/'.$portfolio->level_materia_kursus) ?>" class="badge badge-success"><i class="fa fa-folder-open"></i></a></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
