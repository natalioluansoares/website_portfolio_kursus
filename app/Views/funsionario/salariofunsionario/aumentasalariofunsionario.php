...
<?= $this->section('funsionario') ?>
    <title><?=lang('sidebarPortfolio.aumentaSalarioFunionarioPortfolio')?></title>
<?= $this->endSection() ?>
<?= $this->section('funsionario') ?>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><strong><?=lang('sidebarPortfolio.aumentaSalarioFunionarioPortfolio')?></strong></h4>
            </div>
            <?php $errors = session()->getFlashdata('errors'); ?>
            <div class="card-body">
                <div class="basic-form">
                    <form action="<?=base_url(lang('salarioFunsionario.inputSalarioFunsionarioUrlPortfolio')) ?>" method="post">
                        <?= csrf_field(); ?>
                        <div class="row g-2">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="number" name="total_salario" min="0" class="form-control" value="<?=old('total_salario')?>" id="inputEmail4" placeholder="<?=lang('salarioFunsionario.totalFunsionario')?>">
                                <small class="text-danger">
