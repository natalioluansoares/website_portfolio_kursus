        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="basic-form">
                    <form action="<?=base_url(lang('categorioProjeitoFunsionario.inputCategorioBackendFrontendUrlPortfolio')) ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="row g-2">
                            <div class="mb-3 col-md-4">
                                ...
                                <select name="projeito_backend_frontend" id="" class="form-control">
                                    ...
                                    <option value="<?=$portfolio->id_categorio_backend_frontend ?>"<?= old('projeito_backend_frontend') == $portfolio->id_categorio_backend_frontend ? 'selected' : null ?>><?=$portfolio->categorio_backend_frontend ?>
                                    </option>
                                    <?php endforeach ?>
                                </select>
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <select name="lian_backend_frontend" id="" class="form-control">
                                    <option value=""><?=lang('projeitoBackendPortfolio.hiliLianProjeitoBackendFrontendlPortfolio')?></option>
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="text" name="data_backend_frontend" value="<?=old('data_backend_frontend') ?>" class="form-control" id="mdate" placeholder="<?=date('Y-M-d')?>">
                                <small class="text-danger">
                        ...
                        <div class="row g-2">
                            <div class="mb-3 col-md-6">
                                ...
                                <textarea name="youtube" id="" cols="30" rows="4" placeholder="<?=lang('projeitoBackendPortfolio.youtubeProjeitoBackendFrontend')?>" class="form-control"><?=old('youtube') ?></textarea>
                                <small class="text-danger">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <textarea name="facebook" id="" cols="30" rows="4" placeholder="<?=lang('projeitoBackendPortfolio.facebookProjeitoBackendFrontend')?>" class="form-control"><?=old('facebook') ?></textarea>
                                <small class="text-danger">
                        ...
                        <div class="row g-2">
                            <div class="mb-3 col-md-6">
                                ...
                                <textarea name="instagram" id="" cols="30" placeholder="<?=lang('projeitoBackendPortfolio.instagramProjeitoBackendFrontend')?>" rows="4" class="form-control"><?=old('instagram') ?></textarea>
                                <small class="text-danger">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <textarea name="tiktok" id="" placeholder="<?=lang('projeitoBackendPortfolio.tiktokProjeitoBackendFrontend')?>" cols="30" rows="4" class="form-control"><?=old('tiktok') ?></textarea>
                                <small class="text-danger">
                        ...
                        <div class="row g-2">
                            <div class="mb-3 col-md-12">
                                ...
                                <textarea name="titulo_backend_frontend" id="" cols="30" class="form-control" rows="10"><?=old('titulo_backend_frontend') ?></textarea>
                                <small class="text-danger">
                        ...
                        <div class="row g-2">
                            <div class="mb-3 col-md-12">
                                ...
                                <textarea name="descripsaun_backend_frontend" id="" cols="30" class="form-control" rows="10"><?=old('descripsaun_backend_frontend') ?></textarea>
                                <small class="text-danger">
