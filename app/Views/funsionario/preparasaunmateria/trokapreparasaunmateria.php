    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><?=lang('sidebarPortfolio.trokaPreparaMateriaProfessoresPortfolio')?></strong></h4>
            </div>
            <?php $errors = session()->getFlashdata('errors'); ?>
            <div class="card-body">
                <div class="basic-form">
                    <form action="<?=base_url(lang('preparasaunMateria.updatePreparasaunMateriaUrlPortfolio').$preparasaunmateria->id_preparasaun_materia) ?>" method="post">
                        <?= csrf_field(); ?>
                        <div class="row g-2">
