...
<?php if ($acesso->aumenta_direito_acesso_autromos == 1 && $acesso->osan_subsidio ==1 && $acesso->menu_finansa == 1){ ?>
<div class="mb-3"></div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><strong><?=lang('sidebarPortfolio.aumentaSubsidioPortfolio')?></strong></h4>
            </div>
            <?php $errors = session()->getFlashdata('errors'); ?>
            <div class="card-body">
                <div class="basic-form">
                <form action="<?=base_url(lang('subsidioPortfolio.createSubsidioUrlFunsionario')) ?>" method="post">
                            <?= csrf_field(); ?>
                            <div class="row g-2">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="text"  id="start" name="data_hahu_aktividade"  class="form-control <?=isset($errors['data_hahu_aktividade']) ? 'is-invalid' : null ?>"  value="<?=old('data_hahu_aktividade')?>"  placeholder="<?=lang('subsidioPortfolio.dataHahuSubsidio')?>">
                                    <small class="text-danger">
                                ...
                                <div class="mb-3 col-md-4">
                                    ...
                                    <input type="text" name="data_remata_aktividade" id="end" class="form-control <?=isset($errors['data_remata_aktividade']) ? 'is-invalid' : null ?>"  value="<?=old('data_remata_aktividade')?>"  placeholder="<?=lang('subsidioPortfolio.dataRemataSubsidio')?>">
                                    <small class="text-danger">
                            ...
                            <a href="<?= base_url(lang('subsidioPortfolio.showSubsidioUrlFunsionario').$portfolio->id_osan_sai)?>" class="btn btn-info ms-1"><i class="mdi mdi-skip-previous"></i></a>
                            <?php endforeach; ?>
                        </form>
                </div>
            </div>
