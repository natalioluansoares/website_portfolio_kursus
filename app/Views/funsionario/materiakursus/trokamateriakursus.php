    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><strong><?=lang('sidebarPortfolio.trokaMateriaKursus')?></strong></h4>
            </div>
            <?php $errors = session()->getFlashdata('errors'); ?>
            <div class="card-body">
                <div class="basic-form">
                    <form action="<?=base_url(lang('materiaKursusFunsionario.updatemateriaKursusUrlPortfolio').$materiakursus->id_materia_kursus) ?>" method="post">
                        <?= csrf_field(); ?>
                        <div class="row g-2">
                            <div class="mb-3 col-md-6">
                                <label for="inputEmail4" class="form-label"><?=lang('materiaKursusFunsionario.materia')?></label>
                                <input type="text" name="materia_kursus" value="<?=old('materia_kursus', $materiakursus->materia_kursus) ?>" class="form-control" id="inputEmail4" placeholder="<?=lang('materiaKursusFunsionario.materia')?>">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" name="level_materia_kursus" value="<?=old('level_materia_kursus', $materiakursus->level_materia_kursus) ?>" class="form-control" id="inputPassword4" placeholder="<?=lang('materiaKursusFunsionario.level')?>">
                                <small class="text-danger">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="number" name="preso_materia_kursus" value="<?=old('preso_materia_kursus', $materiakursus->preso_materia_kursus) ?>" class="form-control" id="inputPassword4" placeholder="<?=lang('materiaKursusFunsionario.osan')?>">
                                <small class="text-danger">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <input type="text" name="data_materia_kursus" value="<?=old('data_materia_kursus', $materiakursus->data_materia_kursus	) ?>" class="form-control" id="mdate" placeholder="<?=date('Y-M-d')?>">
                                <small class="text-danger">
