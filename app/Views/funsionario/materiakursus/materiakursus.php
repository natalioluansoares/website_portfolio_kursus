                ...
                <div class="app-search dropdown">
                    <form>
                        <div class="input-group">
                            ...
                            <a href="<?= base_url(lang('materiaKursusFunsionario.aumentamateriaKursusUrlPortfolio')) ?>" class="btn" style="background-color: darkslateblue; color:aliceblue"><i class="fa fa-plus"></i></a>
                            <?php endif; ?>
                        </div>
                    </form>
                </div>
    ...
    <div class="col-lg-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title"><strong><?=lang('sidebarPortfolio.materiaKursus')?></strong></h4>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered table-responsive-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <?php endif; ?>
                                <?php if($acesso->troka_direito_acesso_autromos == 1 && $acesso->classe == 1 && $acesso->menu_classe_horario ==1): ?>
                                <td><a href="<?=base_url(lang('materiaKursusFunsionario.trokamateriaKursusUrlPortfolio').$portfolio->id_materia_kursus) ?>" class="btn btn-success"><i class="fa fa-pencil"></i></a></td>
                                <?php endif; ?>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
...
<div class="modal fade trokamateriakursus" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?=base_url(lang('materiaKursusFunsionario.deletemateriaKursusUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
