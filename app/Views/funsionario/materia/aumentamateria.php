        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="basic-form">
                    <form action="<?=base_url(lang('sciensieFunsionario.inputSciensieFunsionarioUrlPortfolio')) ?>" method="post" enctype="multipart/form-data">
                        <?= csrf_field(); ?>
                        <div class="row g-2">
                            ...
                            <div class="mb-3 col-md-4">
                                ...
                                <input type="date" name="data_materia" value="<?=old('data_materia') ?>" class="form-control" id="inputPassword4" placeholder="<?=lang('materiaPortfolio.dataMateria')?>">
                                <small class="text-danger">
                        ...
                        <div class="row g-2">
                            <div class="mb-3 col-md-6">
                                ...
                                <textarea name="youtube" id="" cols="30" rows="4" placeholder="<?=lang('materiaPortfolio.youtubeMateria')?>" class="form-control"><?=old('youtube') ?></textarea>
                                <small class="text-danger">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <textarea name="facebook" id="" cols="30" rows="4" placeholder="<?=lang('materiaPortfolio.facebookMateria')?>" class="form-control"><?=old('facebook') ?></textarea>
                                <small class="text-danger">
                        ...
                        <div class="row g-2">
                            <div class="mb-3 col-md-6">
                                ...
                                <textarea name="instagram" id="" cols="30" placeholder="<?=lang('materiaPortfolio.instagramMateria')?>" rows="4" class="form-control"><?=old('instagram') ?></textarea>
                                <small class="text-danger">
                            ...
                            <div class="mb-3 col-md-6">
                                ...
                                <textarea name="tiktok" id="" placeholder="<?=lang('materiaPortfolio.tiktokMateria')?>" cols="30" rows="4" class="form-control"><?=old('tiktok') ?></textarea>
                                <small class="text-danger">
                        ...
                        <div class="row g-2">
                            <div class="mb-3 col-md-12">
                                ...
                                <textarea name="titulo_materia" id="" cols="30" class="form-control" rows="10"><?=old('titulo_materia') ?></textarea>
                                <small class="text-danger">
                        ...
                        <a href="<?= base_url(lang('sciensieFunsionario.showSciensieFunsionarioUrlPortfolio').$row->lian_categorio.'/'.$row->id_categorio)?>" class="btn btn-info ms-1"><i class="mdi mdi-skip-previous"></i></a>
                    </form>
                </div>
            </div>
        </div>
