                ...
                <div class="app-search dropdown">
                    <form>
                        <div class="input-group">
                            ...
                            <?php if ($acesso->aumenta_direito_acesso_autromos == 1 && $acesso->professores == 1 && $acesso->menu_profesores == 1) { ?>
                                <a href="<?= base_url(lang('teacherFunsionario.aumentaTeacherUrlPortfolio')) ?>" class="btn" style="background-color: darkslateblue; color:aliceblue"><i class="fa fa-plus"></i></a>
                           <?php } ?>
                        </div>
                    </form>
                </div>
...
<div class="row">
    <div class="col-lg-4">
        <div class="mb-3">
            <h4 class="card-title"><strong><?=lang('professoresPortfolio.registoProfessoresPortfolio')?></strong></h4>
        </div>
    </div>
</div>
<div class="row">
            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="card-footer text-center border-0 mt-0">
                        <?php if ($acesso->hamos_direito_acesso_autromos == 1 && $acesso->professores == 1 && $acesso->menu_profesores == 1) { ?>
                            <a href="" class="btn btn-danger btn-animation btn-rounded px-3" data-animation="swing" data-toggle="modal" data-target=".trokaprofessores" id="professores" 
                            data-id="<?= $portfolio->id_professores; ?>">
                            <i class="fa fa-trash"></i>
                            </a>
                        <?php } ?>
                        <?php if ($acesso->troka_direito_acesso_autromos == 1 && $acesso->professores == 1 && $acesso->menu_profesores == 1) { ?>							
...
<div class="modal fade trokaprofessores" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?=base_url(lang('teacherFunsionario.deleteTeacherUrlPortfolio')) ?>" method="post">
                <?= csrf_field(); ?>
