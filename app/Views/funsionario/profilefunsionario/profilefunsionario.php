                    ...
                    <div class="card">
                        <div class="text-center p-3 overlay-box" style="background-image: url(images/big/img1.jpg);">
                            <div class="profile-photo">
                                <img src="<?= base_url('uploads/fotoportfolio/'.helperFunsionario()->image_administrator)?>" width="100" class="img-fluid rounded-circle" alt="">
                            </div>
                            <h3 class="mt-3 mb-1 text-white"><?= helperFunsionario()->naran_primeiro?></h3>
                        </div>
                        ...
                        <div class="card-body pb-0">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex px-0 justify-content-between">
                                    ...
                                    <span class="mb-0"><?= helperFunsionario()->jenero?></span>
                                </li>
                                <li class="list-group-item d-flex px-0 justify-content-between">
                                ...
                                <li class="list-group-item d-flex px-0 justify-content-between">
                                    <strong>Email</strong>
                                    <span class="mb-0"><?= helperFunsionario()->numero_eleitural?></span>
                                </li>
                                <li class="list-group-item d-flex px-0 justify-content-between">
                                    <strong>Phone</strong>
                                    <span class="mb-0"><?= helperFunsionario()->numero_telefone?></span>
                                </li>
                            </ul>
                        </div>
                                ...
                                <div id="about-me" class="tab-pane fade active show">
                                    <div class="profile-personal-info pt-4">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span><?= helperFunsionario()->naran_kompleto?></span>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                            ...
                                            <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span><?= helperFunsionario()->email?></span>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                            ...
                                            <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span><?= helperFunsionario()->loron_moris?></span>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                            ...
                                            <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span><?= helperFunsionario()->fatin_moris?></span>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="text-center p-3 overlay-box" style="background-image: url(images/big/img1.jpg);">
                            <div class="profile-photo">
                                <img src="<?= base_url('uploads/fotoportfolio/'.helperProfessores()->image_administrator)?>" width="100" class="img-fluid rounded-circle" alt="">
                            </div>
                            <h3 class="mt-3 mb-1 text-white"><?= helperProfessores()->naran_primeiro?></h3>
                        </div>
                        <ul class="list-group list-group-flush">
                            <li class="list-group-item d-flex justify-content-between"><span class="mb-0">Followers</span> <strong class="text-muted">1204	</strong></li>
                            <li class="list-group-item d-flex justify-content-between"><span class="mb-0">Following</span> <strong class="text-muted">2540	</strong></li>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body pb-0">
                            ...
                            <ul class="list-group list-group-flush">
                                <li class="list-group-item d-flex px-0 justify-content-between">
                                    <strong>Gender</strong>
                                    <span class="mb-0"><?= helperProfessores()->jenero?></span>
                                </li>
                                <li class="list-group-item d-flex px-0 justify-content-between">
                                    <strong>Education</strong>
                                    <span class="mb-0">PHD</span>
                                ...
                                <li class="list-group-item d-flex px-0 justify-content-between">
                                    <strong>Email</strong>
                                    <span class="mb-0"><?= helperProfessores()->numero_eleitural?></span>
                                </li>
                                <li class="list-group-item d-flex px-0 justify-content-between">
                                    <strong>Phone</strong>
                                    <span class="mb-0"><?= helperProfessores()->numero_telefone?></span>
                                </li>
                            </ul>
                        </div>
                        <div class="card-footer pt-0 pb-0 text-center">
                                ...
                                <div id="about-me" class="tab-pane fade active show">
                                    <div class="profile-personal-info pt-4">
                                        ...
                                        <div class="row mb-4">
                                            ...
                                            <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span><?= helperProfessores()->naran_kompleto?></span>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                            ...
                                            <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span><?= helperProfessores()->email?></span>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                            ...
                                            <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span><?= helperProfessores()->loron_moris?></span>
                                            </div>
                                        </div>
                                        <div class="row mb-4">
                                            <div class="col-lg-3 col-md-4 col-sm-6 col-6">
                                            ...
                                            <div class="col-lg-9 col-md-8 col-sm-6 col-6"><span><?= helperProfessores()->fatin_moris?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="profile-skills pt-2 border-bottom-1 pb-2">
